...
#
#  File     nfa_accept_samples_generic_hw_top_0_wave.do (Sun Nov 09 09:41:38 2014)
#
...
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_MPLB_Clk
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_MPLB_Rst
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_request
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_priority
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_busLock
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_RNW
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_BE
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_MSize
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_size
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_type
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_TAttribute
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_lockErr
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_abort
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_UABus
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_ABus
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_wrDBus
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_wrBurst
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_M_rdBurst
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MAddrAck
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MSSize
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MRearbitrate
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MTimeout
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MBusy
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MRdErr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MWrErr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MIRQ
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MRdDBus
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MRdWdAddr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MRdDAck
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MRdBTerm
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MWrDAck
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_finals_buckets_PLB_MWrBTerm
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_MPLB_Clk
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_MPLB_Rst
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_request
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_priority
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_busLock
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_RNW
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_BE
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_MSize
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_size
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_type
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_TAttribute
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_lockErr
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_abort
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_UABus
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_ABus
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_wrDBus
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_wrBurst
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_M_rdBurst
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MAddrAck
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MSSize
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MRearbitrate
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MTimeout
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MBusy
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MRdErr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MWrErr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MIRQ
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MRdDBus
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MRdWdAddr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MRdDAck
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MRdBTerm
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MWrDAck
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_forward_buckets_PLB_MWrBTerm
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_MPLB_Clk
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_MPLB_Rst
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_request
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_priority
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_busLock
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_RNW
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_BE
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_MSize
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_size
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_type
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_TAttribute
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_lockErr
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_abort
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_UABus
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_ABus
  eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_wrDBus
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_wrBurst
  eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_M_rdBurst
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MAddrAck
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MSSize
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MRearbitrate
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MTimeout
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MBusy
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MRdErr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MWrErr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MIRQ
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MRdDBus
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MRdWdAddr
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MRdDAck
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MRdBTerm
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MWrDAck
# eval add wave -noupdate $binopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}nfa_initials_buckets_PLB_MWrBTerm
...
# eval add wave -noupdate $hexopt $tbpath${ps}nfa_accept_samples_generic_hw_top_0${ps}splb_slv0_PLB_masterID
