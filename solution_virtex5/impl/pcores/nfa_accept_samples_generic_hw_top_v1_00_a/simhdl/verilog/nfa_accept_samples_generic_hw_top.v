...
parameter C_nfa_initials_buckets_MPMC_BASE_ADDRESS = 32'h00000000;
parameter C_nfa_finals_buckets_MPMC_BASE_ADDRESS = 32'h00000000;
parameter C_nfa_forward_buckets_MPMC_BASE_ADDRESS = 32'h00000000;
...
output [32 - 1:0] nfa_initials_buckets_NPI_Addr ;
output nfa_initials_buckets_NPI_AddrReq ;
input nfa_initials_buckets_NPI_AddrAck ;
output nfa_initials_buckets_NPI_RNW ;
output [4 - 1:0] nfa_initials_buckets_NPI_Size ;
output [64 - 1:0] nfa_initials_buckets_NPI_WrFIFO_Data ;
output [8 - 1:0] nfa_initials_buckets_NPI_WrFIFO_BE ;
output nfa_initials_buckets_NPI_WrFIFO_Push ;
input [64 - 1:0] nfa_initials_buckets_NPI_RdFIFO_Data ;
output nfa_initials_buckets_NPI_RdFIFO_Pop ;
input [4 - 1:0] nfa_initials_buckets_NPI_RdFIFO_RdWdAddr ;
...
input [2 - 1:0] nfa_initials_buckets_NPI_RdFIFO_Latency ;
...
output [32 - 1:0] nfa_finals_buckets_NPI_Addr ;
output nfa_finals_buckets_NPI_AddrReq ;
input nfa_finals_buckets_NPI_AddrAck ;
output nfa_finals_buckets_NPI_RNW ;
output [4 - 1:0] nfa_finals_buckets_NPI_Size ;
output [64 - 1:0] nfa_finals_buckets_NPI_WrFIFO_Data ;
output [8 - 1:0] nfa_finals_buckets_NPI_WrFIFO_BE ;
output nfa_finals_buckets_NPI_WrFIFO_Push ;
input [64 - 1:0] nfa_finals_buckets_NPI_RdFIFO_Data ;
output nfa_finals_buckets_NPI_RdFIFO_Pop ;
input [4 - 1:0] nfa_finals_buckets_NPI_RdFIFO_RdWdAddr ;
...
input [2 - 1:0] nfa_finals_buckets_NPI_RdFIFO_Latency ;
...
output [32 - 1:0] nfa_forward_buckets_NPI_Addr ;
output nfa_forward_buckets_NPI_AddrReq ;
input nfa_forward_buckets_NPI_AddrAck ;
output nfa_forward_buckets_NPI_RNW ;
output [4 - 1:0] nfa_forward_buckets_NPI_Size ;
output [64 - 1:0] nfa_forward_buckets_NPI_WrFIFO_Data ;
output [8 - 1:0] nfa_forward_buckets_NPI_WrFIFO_BE ;
output nfa_forward_buckets_NPI_WrFIFO_Push ;
input [64 - 1:0] nfa_forward_buckets_NPI_RdFIFO_Data ;
output nfa_forward_buckets_NPI_RdFIFO_Pop ;
input [4 - 1:0] nfa_forward_buckets_NPI_RdFIFO_RdWdAddr ;
...
input [2 - 1:0] nfa_forward_buckets_NPI_RdFIFO_Latency ;
...
wire nfa_initials_buckets_NPI_clk;
wire nfa_initials_buckets_NPI_reset;
wire [32 - 1:0] nfa_initials_buckets_NPI_Addr;
wire nfa_initials_buckets_NPI_AddrReq;
wire nfa_initials_buckets_NPI_AddrAck;
wire nfa_initials_buckets_NPI_RNW;
wire [4 - 1:0] nfa_initials_buckets_NPI_Size;
wire [64 - 1:0] nfa_initials_buckets_NPI_WrFIFO_Data;
wire [8 - 1:0] nfa_initials_buckets_NPI_WrFIFO_BE;
wire nfa_initials_buckets_NPI_WrFIFO_Push;
wire [64 - 1:0] nfa_initials_buckets_NPI_RdFIFO_Data;
wire nfa_initials_buckets_NPI_RdFIFO_Pop;
wire [4 - 1:0] nfa_initials_buckets_NPI_RdFIFO_RdWdAddr;
wire nfa_initials_buckets_NPI_WrFIFO_Empty;
wire nfa_initials_buckets_NPI_WrFIFO_AlmostFull;
wire nfa_initials_buckets_NPI_WrFIFO_Flush;
wire nfa_initials_buckets_NPI_RdFIFO_Empty;
wire nfa_initials_buckets_NPI_RdFIFO_Flush;
wire [2 - 1:0] nfa_initials_buckets_NPI_RdFIFO_Latency;
wire nfa_initials_buckets_NPI_RdModWr;
wire nfa_initials_buckets_NPI_InitDone;


wire nfa_finals_buckets_NPI_clk;
wire nfa_finals_buckets_NPI_reset;
wire [32 - 1:0] nfa_finals_buckets_NPI_Addr;
wire nfa_finals_buckets_NPI_AddrReq;
wire nfa_finals_buckets_NPI_AddrAck;
wire nfa_finals_buckets_NPI_RNW;
wire [4 - 1:0] nfa_finals_buckets_NPI_Size;
wire [64 - 1:0] nfa_finals_buckets_NPI_WrFIFO_Data;
wire [8 - 1:0] nfa_finals_buckets_NPI_WrFIFO_BE;
wire nfa_finals_buckets_NPI_WrFIFO_Push;
wire [64 - 1:0] nfa_finals_buckets_NPI_RdFIFO_Data;
wire nfa_finals_buckets_NPI_RdFIFO_Pop;
wire [4 - 1:0] nfa_finals_buckets_NPI_RdFIFO_RdWdAddr;
wire nfa_finals_buckets_NPI_WrFIFO_Empty;
wire nfa_finals_buckets_NPI_WrFIFO_AlmostFull;
wire nfa_finals_buckets_NPI_WrFIFO_Flush;
wire nfa_finals_buckets_NPI_RdFIFO_Empty;
wire nfa_finals_buckets_NPI_RdFIFO_Flush;
wire [2 - 1:0] nfa_finals_buckets_NPI_RdFIFO_Latency;
wire nfa_finals_buckets_NPI_RdModWr;
wire nfa_finals_buckets_NPI_InitDone;


wire nfa_forward_buckets_NPI_clk;
wire nfa_forward_buckets_NPI_reset;
wire [32 - 1:0] nfa_forward_buckets_NPI_Addr;
wire nfa_forward_buckets_NPI_AddrReq;
wire nfa_forward_buckets_NPI_AddrAck;
wire nfa_forward_buckets_NPI_RNW;
wire [4 - 1:0] nfa_forward_buckets_NPI_Size;
wire [64 - 1:0] nfa_forward_buckets_NPI_WrFIFO_Data;
wire [8 - 1:0] nfa_forward_buckets_NPI_WrFIFO_BE;
wire nfa_forward_buckets_NPI_WrFIFO_Push;
wire [64 - 1:0] nfa_forward_buckets_NPI_RdFIFO_Data;
wire nfa_forward_buckets_NPI_RdFIFO_Pop;
wire [4 - 1:0] nfa_forward_buckets_NPI_RdFIFO_RdWdAddr;
wire nfa_forward_buckets_NPI_WrFIFO_Empty;
wire nfa_forward_buckets_NPI_WrFIFO_AlmostFull;
wire nfa_forward_buckets_NPI_WrFIFO_Flush;
wire nfa_forward_buckets_NPI_RdFIFO_Empty;
wire nfa_forward_buckets_NPI_RdFIFO_Flush;
wire [2 - 1:0] nfa_forward_buckets_NPI_RdFIFO_Latency;
wire nfa_forward_buckets_NPI_RdModWr;
wire nfa_forward_buckets_NPI_InitDone;
...
nfa_initials_buckets_if #(
    .MPMC_BASE_ADDRESS(C_nfa_initials_buckets_MPMC_BASE_ADDRESS))
nfa_initials_buckets_if_U(
    ...
    .ap_clk(aclk),
    .ap_reset(aresetn),
    .NPI_clk(nfa_initials_buckets_NPI_clk),
    .NPI_reset(nfa_initials_buckets_NPI_reset),
    .NPI_Addr(nfa_initials_buckets_NPI_Addr),
    .NPI_AddrReq(nfa_initials_buckets_NPI_AddrReq),
    .NPI_AddrAck(nfa_initials_buckets_NPI_AddrAck),
    .NPI_RNW(nfa_initials_buckets_NPI_RNW),
    .NPI_Size(nfa_initials_buckets_NPI_Size),
    .NPI_WrFIFO_Data(nfa_initials_buckets_NPI_WrFIFO_Data),
    .NPI_WrFIFO_BE(nfa_initials_buckets_NPI_WrFIFO_BE),
    .NPI_WrFIFO_Push(nfa_initials_buckets_NPI_WrFIFO_Push),
    .NPI_RdFIFO_Data(nfa_initials_buckets_NPI_RdFIFO_Data),
    .NPI_RdFIFO_Pop(nfa_initials_buckets_NPI_RdFIFO_Pop),
    .NPI_RdFIFO_RdWdAddr(nfa_initials_buckets_NPI_RdFIFO_RdWdAddr),
    .NPI_WrFIFO_Empty(nfa_initials_buckets_NPI_WrFIFO_Empty),
    .NPI_WrFIFO_AlmostFull(nfa_initials_buckets_NPI_WrFIFO_AlmostFull),
    .NPI_WrFIFO_Flush(nfa_initials_buckets_NPI_WrFIFO_Flush),
    .NPI_RdFIFO_Empty(nfa_initials_buckets_NPI_RdFIFO_Empty),
    .NPI_RdFIFO_Flush(nfa_initials_buckets_NPI_RdFIFO_Flush),
    .NPI_RdFIFO_Latency(nfa_initials_buckets_NPI_RdFIFO_Latency),
    .NPI_RdModWr(nfa_initials_buckets_NPI_RdModWr),
    .NPI_InitDone(nfa_initials_buckets_NPI_InitDone));

nfa_finals_buckets_if #(
    .MPMC_BASE_ADDRESS(C_nfa_finals_buckets_MPMC_BASE_ADDRESS))
nfa_finals_buckets_if_U(
    ...
    .ap_clk(aclk),
    .ap_reset(aresetn),
    .NPI_clk(nfa_finals_buckets_NPI_clk),
    .NPI_reset(nfa_finals_buckets_NPI_reset),
    .NPI_Addr(nfa_finals_buckets_NPI_Addr),
    .NPI_AddrReq(nfa_finals_buckets_NPI_AddrReq),
    .NPI_AddrAck(nfa_finals_buckets_NPI_AddrAck),
    .NPI_RNW(nfa_finals_buckets_NPI_RNW),
    .NPI_Size(nfa_finals_buckets_NPI_Size),
    .NPI_WrFIFO_Data(nfa_finals_buckets_NPI_WrFIFO_Data),
    .NPI_WrFIFO_BE(nfa_finals_buckets_NPI_WrFIFO_BE),
    .NPI_WrFIFO_Push(nfa_finals_buckets_NPI_WrFIFO_Push),
    .NPI_RdFIFO_Data(nfa_finals_buckets_NPI_RdFIFO_Data),
    .NPI_RdFIFO_Pop(nfa_finals_buckets_NPI_RdFIFO_Pop),
    .NPI_RdFIFO_RdWdAddr(nfa_finals_buckets_NPI_RdFIFO_RdWdAddr),
    .NPI_WrFIFO_Empty(nfa_finals_buckets_NPI_WrFIFO_Empty),
    .NPI_WrFIFO_AlmostFull(nfa_finals_buckets_NPI_WrFIFO_AlmostFull),
    .NPI_WrFIFO_Flush(nfa_finals_buckets_NPI_WrFIFO_Flush),
    .NPI_RdFIFO_Empty(nfa_finals_buckets_NPI_RdFIFO_Empty),
    .NPI_RdFIFO_Flush(nfa_finals_buckets_NPI_RdFIFO_Flush),
    .NPI_RdFIFO_Latency(nfa_finals_buckets_NPI_RdFIFO_Latency),
    .NPI_RdModWr(nfa_finals_buckets_NPI_RdModWr),
    .NPI_InitDone(nfa_finals_buckets_NPI_InitDone));

nfa_forward_buckets_if #(
    .MPMC_BASE_ADDRESS(C_nfa_forward_buckets_MPMC_BASE_ADDRESS))
nfa_forward_buckets_if_U(
    ...
    .ap_clk(aclk),
    .ap_reset(aresetn),
    .NPI_clk(nfa_forward_buckets_NPI_clk),
    .NPI_reset(nfa_forward_buckets_NPI_reset),
    .NPI_Addr(nfa_forward_buckets_NPI_Addr),
    .NPI_AddrReq(nfa_forward_buckets_NPI_AddrReq),
    .NPI_AddrAck(nfa_forward_buckets_NPI_AddrAck),
    .NPI_RNW(nfa_forward_buckets_NPI_RNW),
    .NPI_Size(nfa_forward_buckets_NPI_Size),
    .NPI_WrFIFO_Data(nfa_forward_buckets_NPI_WrFIFO_Data),
    .NPI_WrFIFO_BE(nfa_forward_buckets_NPI_WrFIFO_BE),
    .NPI_WrFIFO_Push(nfa_forward_buckets_NPI_WrFIFO_Push),
    .NPI_RdFIFO_Data(nfa_forward_buckets_NPI_RdFIFO_Data),
    .NPI_RdFIFO_Pop(nfa_forward_buckets_NPI_RdFIFO_Pop),
    .NPI_RdFIFO_RdWdAddr(nfa_forward_buckets_NPI_RdFIFO_RdWdAddr),
    .NPI_WrFIFO_Empty(nfa_forward_buckets_NPI_WrFIFO_Empty),
    .NPI_WrFIFO_AlmostFull(nfa_forward_buckets_NPI_WrFIFO_AlmostFull),
    .NPI_WrFIFO_Flush(nfa_forward_buckets_NPI_WrFIFO_Flush),
    .NPI_RdFIFO_Empty(nfa_forward_buckets_NPI_RdFIFO_Empty),
    .NPI_RdFIFO_Flush(nfa_forward_buckets_NPI_RdFIFO_Flush),
    .NPI_RdFIFO_Latency(nfa_forward_buckets_NPI_RdFIFO_Latency),
    .NPI_RdModWr(nfa_forward_buckets_NPI_RdModWr),
    .NPI_InitDone(nfa_forward_buckets_NPI_InitDone));
