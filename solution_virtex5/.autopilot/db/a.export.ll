...
@p_str223 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@p_str324 = private unnamed_addr constant [28 x i8] c"state < nfa_get_states(nfa)\00", align 1
@p_str425 = private unnamed_addr constant [27 x i8] c"sym < nfa_get_symbols(nfa)\00", align 1
@p_str1132 = private unnamed_addr constant [45 x i8] c"offset <= sample_buffer_size - sample_length\00", align 1
...
@p_str31 = private unnamed_addr constant [7 x i8] c"NPI64M\00", align 1
...
@p_str34 = private unnamed_addr constant [7 x i8] c"PLB46M\00", align 1
@p_str35 = private unnamed_addr constant [12 x i8] c"hls_label_2\00", align 1
...
@p_str984 = private unnamed_addr constant [9 x i8] c"bus != 0\00", align 1
...
._crit_edge:
  ...
  br i1 %tmp_3, label %.preheader, label %0
...
.preheader:                                       ; preds = %._crit_edge
  %tmp_25_1 = icmp eq i2 %tmp, 0
  br i1 %tmp_25_1, label %2, label %.loopexit

; <label>:2                                       ; preds = %.preheader
  %tmp_27_1 = icmp eq i32 %p_read_1, 0
  br i1 %tmp_27_1, label %.loopexit, label %1
...
define i32 @nfa_accept_samples_generic_hw(i32* %nfa_initials_buckets, i32* %nfa_finals_buckets, i32* %nfa_forward_buckets, [32130 x i32]* %nfa_backward_buckets, i8* %nfa_symbols, i8* %sample_buffer, i32 %sample_buffer_length, i16 zeroext %sample_length, i56* %indices, i16 zeroext %i_size, i16 %begin_index, i16 %begin_sample, i16 %end_index, i16 %end_sample, i1 zeroext %stop_on_first, i1 zeroext %accept) {
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str223) nounwind
  ...
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa_forward_buckets, [7 x i8]* @p_str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223)
  call void (...)* @_ssdm_op_SpecWire(i8* %nfa_symbols, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  ...
  call void (...)* @_ssdm_op_SpecWire(i32 %sample_buffer_length, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  call void (...)* @_ssdm_op_SpecWire(i16 %sample_length, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  ...
  call void (...)* @_ssdm_op_SpecWire(i16 %i_size, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  call void (...)* @_ssdm_op_SpecWire(i16 %begin_index, i16 %begin_sample, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  call void (...)* @_ssdm_op_SpecWire(i16 %end_index, i16 %end_sample, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  call void (...)* @_ssdm_op_SpecWire(i1 %stop_on_first, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  call void (...)* @_ssdm_op_SpecWire(i1 %accept, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  call void (...)* @_ssdm_op_SpecWire(i32 0, [11 x i8]* @p_str30, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223) nounwind
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa_forward_buckets, [1 x i8]* @p_str223, [7 x i8]* @p_str31, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223)
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i8* %sample_buffer, [1 x i8]* @p_str223, [7 x i8]* @p_str34, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %sample_buffer_length, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i16 %i_size, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
  call void (...)* @_ssdm_op_SpecIFCore(i16 %begin_index, i16 %begin_sample, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i1 %stop_on_first, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
  call void (...)* @_ssdm_op_SpecIFCore(i1 %accept, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 65535, i32 2000, [1 x i8]* @p_str223) nounwind
...
; <label>:3                                       ; preds = %8, %2
  ...
  %sum = add i64 %p_01_rec_i, %tmp_6
  %sample_buffer_addr = getelementptr i8* %sample_buffer, i64 %sum
  %tmp_7 = icmp ult i16 %i_0_i, %sample_length_read
  %i = add i16 %i_0_i, 1
  br i1 %tmp_7, label %4, label %bitset_any.exit

; <label>:4                                       ; preds = %3
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str1233)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1024, i32 512, [1 x i8]* @p_str223) nounwind
  ...
  %tmp_18_i = icmp eq i32 %next_buckets_0, 0
  br i1 %tmp_18_i, label %6, label %5
...
; <label>:6                                       ; preds = %4
  %tmp_18_1_i = icmp eq i32 %next_buckets_1, 0
  br i1 %tmp_18_1_i, label %bitset_first.exit.preheader, label %5
...
bitset_first.exit.preheader:                      ; preds = %5, %6
  ...
  %tmp_5_i_cast = zext i8 %sym to i14
...
bitset_element.exit:                              ; preds = %bitset_first.exit
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 64, i32 5, [1 x i8]* @p_str223) nounwind
  %tmp_5 = trunc i8 %j_bucket_index1 to i1
  %tmp_i1 = call i6 @_ssdm_op_BitConcatenate.i6.i1.i5(i1 %tmp_5, i5 0)
  %tmp_8 = trunc i8 %j_bit1 to i6
  %state = add i6 %tmp_i1, %tmp_8
  call void (...)* @_ssdm_op_SpecIFCore(i8* %nfa_symbols, [1 x i8]* @p_str223, [7 x i8]* @p_str32, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [1 x i8]* @p_str223, [17 x i8]* @p_str33)
  %nfa_symbols_read = call i8 @_ssdm_op_Read.ap_none.i8P(i8* %nfa_symbols)
  %tmp_2_i_cast = zext i6 %state to i14
  %tmp_3_i_cast = zext i8 %nfa_symbols_read to i14
  %tmp_4_i = mul i14 %tmp_3_i_cast, %tmp_2_i_cast
  %tmp_6_i = add i14 %tmp_4_i, %tmp_5_i_cast
  %tmp_7_i = call i15 @_ssdm_op_BitConcatenate.i15.i14.i1(i14 %tmp_6_i, i1 false)
  %tmp_7_i_cast = zext i15 %tmp_7_i to i64
  %nfa_forward_buckets_addr = getelementptr i32* %nfa_forward_buckets, i64 %tmp_7_i_cast
  ...
  %tmp_8_i = call i15 @_ssdm_op_BitConcatenate.i15.i14.i1(i14 %tmp_6_i, i1 true)
  %tmp_8_i_cast = zext i15 %tmp_8_i to i64
  %nfa_forward_buckets_addr_1 = getelementptr i32* %nfa_forward_buckets, i64 %tmp_8_i_cast
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_3)
...
; <label>:8                                       ; preds = %7
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str1233, i32 %tmp_2)
  br label %3
...
._crit_edge3:                                     ; preds = %10, %nfa_accept_sample.exit
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str35, i32 %tmp)
...
._crit_edge:
  ...
  %tmp_5_cast = zext i16 %i_sample_read to i24
  %tmp_6 = mul i24 %tmp_5_cast, %tmp_cast
  %tmp_6_cast = zext i24 %tmp_6 to i32
  %offset = add i32 %tmp_6_cast, %tmp_9
  ret i32 %offset
}
...
define internal fastcc { i16, i16 } @sample_iterator_next(i56* %indices, i16 %i_index, i16 %i_sample) readonly {
  ...
  %tmp_7 = zext i16 %i_index_read to i64
  %indices_addr = getelementptr i56* %indices, i64 %tmp_7
  %indices_load_req = call i1 @_ssdm_op_ReadReq.ap_bus.i56P(i56* %indices_addr, i32 1)
  %indices_addr_read = call i56 @_ssdm_op_Read.ap_bus.i56P(i56* %indices_addr)
  %indices_samples_load_new5 = call i16 @_ssdm_op_PartSelect.i16.i56.i32.i32(i56 %indices_addr_read, i32 32, i32 47)
  %tmp_8_cast = zext i16 %indices_samples_load_new5 to i17
  %tmp_9 = add i17 %tmp_8_cast, -1
  %tmp_9_cast = sext i17 %tmp_9 to i18
  %tmp_s = icmp slt i18 %tmp_cast, %tmp_9_cast
  %tmp_2 = add i16 %i_index_read, 1
  %tmp_1 = add i16 %i_sample_read, 1
  %agg_result_sample_write_assign = select i1 %tmp_s, i16 %tmp_1, i16 0
  %agg_result_index_write_assign = select i1 %tmp_s, i16 %i_index_read, i16 %tmp_2
