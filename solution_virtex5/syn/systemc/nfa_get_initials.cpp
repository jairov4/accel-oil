...
const sc_lv<2> nfa_get_initials::ap_ST_pp0_stg0_fsm_0 = "10";
const sc_lv<2> nfa_get_initials::ap_ST_pp0_stg1_fsm_1 = "00";
const sc_lv<2> nfa_get_initials::ap_ST_pp0_stg2_fsm_2 = "1";
const sc_lv<2> nfa_get_initials::ap_ST_pp0_stg3_fsm_3 = "11";
...
nfa_get_initials::nfa_get_initials(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_ce );
    sensitive << ( nfa_initials_buckets_rsp_empty_n );
    sensitive << ( nfa_initials_buckets_read_reg_59 );
    ...
    sc_trace(mVcdFile, nfa_initials_buckets_read_reg_59, "nfa_initials_buckets_read_reg_59");
...
void nfa_get_initials::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0))) && 
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()) && esl_seteq<1,2,2>(ap_ST_pp0_stg2_fsm_2, ap_CS_fsm.read()) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0)))) {
        nfa_initials_buckets_read_reg_59 = nfa_initials_buckets_datain.read();
    }
}
...
void nfa_get_initials::thread_ap_done() {
    if (((!esl_seteq<1,1,1>(ap_const_logic_1, ap_start.read()) && 
         ...
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && 
          ...
          !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0))))) {
...
void nfa_get_initials::thread_ap_return_0() {
    ap_return_0 = nfa_initials_buckets_read_reg_59.read();
}
