...
sample_iterator_get_offset::sample_iterator_get_offset(sc_module_name name) : sc_module(name), mVcdFile(0) {
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0 = new nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9<0,9,16,8,24>("nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0");
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0->clk(ap_clk);
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0->reset(ap_rst);
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0->din0(grp_fu_110_p0);
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0->din1(grp_fu_110_p1);
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0->ce(grp_fu_110_ce);
    nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0->dout(grp_fu_110_p2);
    ...
    sensitive << ( indices_begin_rsp_empty_n );
    sensitive << ( ap_ce );
    sensitive << ( ap_reg_ppstg_tmp_reg_135_pp0_it8 );
    ...
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_135_pp0_it4, "ap_reg_ppstg_tmp_reg_135_pp0_it4");
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_135_pp0_it5, "ap_reg_ppstg_tmp_reg_135_pp0_it5");
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_135_pp0_it6, "ap_reg_ppstg_tmp_reg_135_pp0_it6");
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_135_pp0_it7, "ap_reg_ppstg_tmp_reg_135_pp0_it7");
    sc_trace(mVcdFile, ap_reg_ppstg_tmp_reg_135_pp0_it8, "ap_reg_ppstg_tmp_reg_135_pp0_it8");
...
sample_iterator_get_offset::~sample_iterator_get_offset() {
    ...
    delete nfa_accept_samples_generic_hw_mul_16ns_8ns_24_9_U0;
...
void sample_iterator_get_offset::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(indices_stride_rsp_empty_n.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it10.read()) && 
  ...
  esl_seteq<1,1,1>(indices_begin_rsp_empty_n.read(), ap_const_logic_0))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
        ...
        ap_reg_ppstg_tmp_reg_135_pp0_it4 = ap_reg_ppstg_tmp_reg_135_pp0_it3.read();
        ap_reg_ppstg_tmp_reg_135_pp0_it5 = ap_reg_ppstg_tmp_reg_135_pp0_it4.read();
        ap_reg_ppstg_tmp_reg_135_pp0_it6 = ap_reg_ppstg_tmp_reg_135_pp0_it5.read();
        ap_reg_ppstg_tmp_reg_135_pp0_it7 = ap_reg_ppstg_tmp_reg_135_pp0_it6.read();
        ap_reg_ppstg_tmp_reg_135_pp0_it8 = ap_reg_ppstg_tmp_reg_135_pp0_it7.read();
    }
  ...
  esl_seteq<1,1,1>(indices_begin_rsp_empty_n.read(), ap_const_logic_0))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_ST_pp0_stg0_fsm_0, ap_CS_fsm.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it10.read()) && !((esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && 
  esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && 
  esl_seteq<1,1,1>(indices_stride_rsp_empty_n.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it10.read()) && 
  esl_seteq<1,1,1>(indices_begin_rsp_empty_n.read(), ap_const_logic_0))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
...
void sample_iterator_get_offset::thread_indices_begin_address() {
    indices_begin_address = ap_reg_ppstg_tmp_reg_135_pp0_it8.read();
}
