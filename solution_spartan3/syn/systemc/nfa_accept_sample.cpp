...
const sc_lv<6> nfa_accept_sample::ap_ST_st46_fsm_45 = "101101";
const sc_lv<6> nfa_accept_sample::ap_ST_st47_fsm_46 = "101110";
const sc_lv<6> nfa_accept_sample::ap_ST_st48_fsm_47 = "101111";
const sc_lv<6> nfa_accept_sample::ap_ST_st49_fsm_48 = "110000";
const sc_lv<6> nfa_accept_sample::ap_ST_st50_fsm_49 = "110001";
...
nfa_accept_sample::nfa_accept_sample(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21 = new nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9<21,9,8,6,14>("nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21");
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21->clk(ap_clk);
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21->reset(ap_rst);
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21->din0(grp_fu_476_p0);
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21->din1(grp_fu_476_p1);
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21->ce(grp_fu_476_ce);
    nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21->dout(grp_fu_476_p2);
    ...
    sensitive << ( ap_CS_fsm );
    sensitive << ( tmp_6_i_reg_680 );

    SC_METHOD(thread_grp_fu_482_p1);
    sensitive << ( ap_CS_fsm );
    sensitive << ( tmp_7_i_cast_reg_650 );
    ...
    sensitive << ( tmp_4_i_cast_fu_509_p1 );
    sensitive << ( tmp_8_i_cast_fu_527_p1 );
    ...
    SC_METHOD(thread_tmp_17_1_i_fu_426_p2);
    sensitive << ( ap_CS_fsm );
    sensitive << ( sample_rsp_empty_n );
    sensitive << ( tmp_17_i_reg_612 );
    sensitive << ( next_buckets_1_reg_158 );

    SC_METHOD(thread_tmp_17_i_fu_420_p2);
    sensitive << ( ap_CS_fsm );
    sensitive << ( next_buckets_0_reg_168 );
    ...
    SC_METHOD(thread_tmp_4_i_cast_fu_509_p1);
    sensitive << ( tmp_4_i_fu_502_p3 );

    SC_METHOD(thread_tmp_4_i_fu_502_p3);
    sensitive << ( offset_i_reg_705 );

    SC_METHOD(thread_tmp_5_fu_447_p1);
    sensitive << ( j_bucket_index1_reg_289 );

    SC_METHOD(thread_tmp_7_i_cast_fu_444_p1);
    sensitive << ( sym_reg_621 );

    SC_METHOD(thread_tmp_8_i_cast_fu_527_p1);
    sensitive << ( tmp_8_i_fu_520_p3 );

    SC_METHOD(thread_tmp_8_i_fu_520_p3);
    sensitive << ( offset_i_reg_705 );
    ...
    sc_trace(mVcdFile, tmp_17_i_fu_420_p2, "tmp_17_i_fu_420_p2");
    sc_trace(mVcdFile, tmp_17_i_reg_612, "tmp_17_i_reg_612");
    ...
    sc_trace(mVcdFile, tmp_17_1_i_fu_426_p2, "tmp_17_1_i_fu_426_p2");
    sc_trace(mVcdFile, tmp_17_1_i_reg_626, "tmp_17_1_i_reg_626");
    ...
    sc_trace(mVcdFile, tmp_7_i_cast_fu_444_p1, "tmp_7_i_cast_fu_444_p1");
    sc_trace(mVcdFile, tmp_7_i_cast_reg_650, "tmp_7_i_cast_reg_650");
    ...
    sc_trace(mVcdFile, tmp_6_i_reg_680, "tmp_6_i_reg_680");
    sc_trace(mVcdFile, j_bit_reg_685, "j_bit_reg_685");
    sc_trace(mVcdFile, j_bucket_index_reg_690, "j_bucket_index_reg_690");
    sc_trace(mVcdFile, j_bucket_reg_695, "j_bucket_reg_695");
    sc_trace(mVcdFile, p_s_reg_700, "p_s_reg_700");
    sc_trace(mVcdFile, grp_fu_482_p2, "grp_fu_482_p2");
    sc_trace(mVcdFile, offset_i_reg_705, "offset_i_reg_705");
    ...
    sc_trace(mVcdFile, tmp_4_i_cast_fu_509_p1, "tmp_4_i_cast_fu_509_p1");
    sc_trace(mVcdFile, tmp_8_i_cast_fu_527_p1, "tmp_8_i_cast_fu_527_p1");
    ...
    sc_trace(mVcdFile, tmp_4_i_fu_502_p3, "tmp_4_i_fu_502_p3");
    sc_trace(mVcdFile, tmp_8_i_fu_520_p3, "tmp_8_i_fu_520_p3");
...
nfa_accept_sample::~nfa_accept_sample() {
    ...
    delete nfa_accept_samples_generic_hw_mul_8ns_6ns_14_9_U21;
...
void nfa_accept_sample::thread_ap_clk_no_reset_() {
    if ((esl_seteq<1,6,6>(ap_ST_st20_fsm_19, ap_CS_fsm.read()) && 
         esl_seteq<1,1,1>(tmp_17_1_i_reg_626.read(), ap_const_lv1_0))) {
        agg_result_bucket_index_0_lcssa4_i_reg_190 = ap_const_lv1_1;
                ...
                esl_seteq<1,1,1>(tmp_17_i_reg_612.read(), ap_const_lv1_0))) {
    ...
    if (esl_seteq<1,6,6>(ap_ST_st24_fsm_23, ap_CS_fsm.read())) {
        ...
        j_bit1_reg_299 = j_bit_reg_685.read();
    }
    ...
    if (esl_seteq<1,6,6>(ap_ST_st24_fsm_23, ap_CS_fsm.read())) {
        ...
        j_bucket1_reg_278 = j_bucket_reg_695.read();
    }
    if (esl_seteq<1,6,6>(ap_ST_st23_fsm_22, ap_CS_fsm.read())) {
    ...
    if (esl_seteq<1,6,6>(ap_ST_st24_fsm_23, ap_CS_fsm.read())) {
        ...
        j_bucket_index1_reg_289 = j_bucket_index_reg_690.read();
    }
    if (esl_seteq<1,6,6>(ap_ST_st23_fsm_22, ap_CS_fsm.read())) {
    ...
    if (esl_seteq<1,6,6>(ap_ST_st24_fsm_23, ap_CS_fsm.read())) {
        ...
        j_end_reg_309 = p_s_reg_700.read();
    }
    if ((esl_seteq<1,6,6>(ap_ST_st25_fsm_24, ap_CS_fsm.read()) && 
         !esl_seteq<1,1,1>(ap_const_lv1_0, j_end_phi_fu_312_p4.read()) && 
         !esl_seteq<1,1,1>(ap_const_lv1_0, any_phi_fu_324_p4.read()))) {
    ...
    if (esl_seteq<1,6,6>(ap_ST_st36_fsm_35, ap_CS_fsm.read())) {
        j_bit_reg_685 = grp_bitset_next_fu_344_ap_return_0.read();
        j_bucket_index_reg_690 = grp_bitset_next_fu_344_ap_return_1.read();
        j_bucket_reg_695 = grp_bitset_next_fu_344_ap_return_2.read();
        p_s_reg_700 = grp_bitset_next_fu_344_ap_return_3.read();
    }
    ...
    if (esl_seteq<1,6,6>(ap_ST_st39_fsm_38, ap_CS_fsm.read())) {
        offset_i_reg_705 = grp_fu_482_p2.read();
    }
  ...
  esl_seteq<1,6,6>(ap_ST_st42_fsm_41, ap_CS_fsm.read())))) {
    ...
    if ((esl_seteq<1,6,6>(ap_ST_st19_fsm_18, ap_CS_fsm.read()) && !esl_seteq<1,1,1>(sample_rsp_empty_n.read(), ap_const_logic_0) && !esl_seteq<1,1,1>(tmp_17_i_reg_612.read(), ap_const_lv1_0))) {
        tmp_17_1_i_reg_626 = tmp_17_1_i_fu_426_p2.read();
    }
    if (esl_seteq<1,6,6>(ap_ST_st18_fsm_17, ap_CS_fsm.read())) {
        tmp_17_i_reg_612 = tmp_17_i_fu_420_p2.read();
    }
    ...
    if (esl_seteq<1,6,6>(ap_ST_st35_fsm_34, ap_CS_fsm.read())) {
        tmp_6_i_reg_680 = grp_fu_476_p2.read();
    }
    if (esl_seteq<1,6,6>(ap_ST_st24_fsm_23, ap_CS_fsm.read())) {
        tmp_7_i_cast_reg_650 = tmp_7_i_cast_fu_444_p1.read();
    }
...
void nfa_accept_sample::thread_grp_fu_482_p0() {
    grp_fu_482_p0 = tmp_6_i_reg_680.read();
}

void nfa_accept_sample::thread_grp_fu_482_p1() {
    grp_fu_482_p1 = tmp_7_i_cast_reg_650.read();
}
...
void nfa_accept_sample::thread_nfa_forward_buckets_address() {
    if ((esl_seteq<1,6,6>(ap_ST_st41_fsm_40, ap_CS_fsm.read()) && 
        ...
        nfa_forward_buckets_address = tmp_8_i_cast_fu_527_p1.read();
    } else if (esl_seteq<1,6,6>(ap_ST_st40_fsm_39, ap_CS_fsm.read())) {
        nfa_forward_buckets_address = tmp_4_i_cast_fu_509_p1.read();
    } else {
...
void nfa_accept_sample::thread_tmp_17_1_i_fu_426_p2() {
    tmp_17_1_i_fu_426_p2 = (!next_buckets_1_reg_158.read().is_01() || !ap_const_lv32_0.is_01())? sc_lv<1>(): sc_lv<1>(next_buckets_1_reg_158.read() == ap_const_lv32_0);
}

void nfa_accept_sample::thread_tmp_17_i_fu_420_p2() {
    tmp_17_i_fu_420_p2 = (!next_buckets_0_reg_168.read().is_01() || !ap_const_lv32_0.is_01())? sc_lv<1>(): sc_lv<1>(next_buckets_0_reg_168.read() == ap_const_lv32_0);
}
...
void nfa_accept_sample::thread_tmp_4_i_cast_fu_509_p1() {
    tmp_4_i_cast_fu_509_p1 = esl_zext<32,15>(tmp_4_i_fu_502_p3.read());
}

void nfa_accept_sample::thread_tmp_4_i_fu_502_p3() {
    tmp_4_i_fu_502_p3 = esl_concat<14,1>(offset_i_reg_705.read(), ap_const_lv1_0);
}
...
void nfa_accept_sample::thread_tmp_7_i_cast_fu_444_p1() {
    tmp_7_i_cast_fu_444_p1 = esl_zext<14,8>(sym_reg_621.read());
}

void nfa_accept_sample::thread_tmp_8_i_cast_fu_527_p1() {
    tmp_8_i_cast_fu_527_p1 = esl_zext<32,15>(tmp_8_i_fu_520_p3.read());
}

void nfa_accept_sample::thread_tmp_8_i_fu_520_p3() {
    tmp_8_i_fu_520_p3 = esl_concat<14,1>(offset_i_reg_705.read(), ap_const_lv1_1);
}
...
void nfa_accept_sample::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint()) {
        ...
        case 17 : 
            ...
            break;
        case 18 : 
            if ((!esl_seteq<1,1,1>(sample_rsp_empty_n.read(), ap_const_logic_0) && esl_seteq<1,1,1>(tmp_17_i_reg_612.read(), ap_const_lv1_0))) {
                ap_NS_fsm = ap_ST_st21_fsm_20;
            } else if ((!esl_seteq<1,1,1>(sample_rsp_empty_n.read(), ap_const_logic_0) && !esl_seteq<1,1,1>(tmp_17_i_reg_612.read(), ap_const_lv1_0))) {
            ...
            break;
        case 19 : 
            if (!esl_seteq<1,1,1>(tmp_17_1_i_reg_626.read(), ap_const_lv1_0)) {
