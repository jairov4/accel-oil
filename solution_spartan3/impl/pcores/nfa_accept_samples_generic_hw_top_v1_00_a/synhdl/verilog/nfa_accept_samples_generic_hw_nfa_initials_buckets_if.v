...
module nfa_accept_samples_generic_hw_nfa_initials_buckets_if/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// nfa_accept_samples_generic_hw_nfa_initials_buckets_request_preprocessor
nfa_accept_samples_generic_hw_nfa_initials_buckets_request_preprocessor #(
...
// nfa_accept_samples_generic_hw_nfa_initials_buckets_write
nfa_accept_samples_generic_hw_nfa_initials_buckets_write #(
...
// nfa_accept_samples_generic_hw_nfa_initials_buckets_read
nfa_accept_samples_generic_hw_nfa_initials_buckets_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
module nfa_accept_samples_generic_hw_nfa_initials_buckets_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
//------------------------Instantiation------------------
// nfa_accept_samples_generic_hw_nfa_initials_buckets_fifo
nfa_accept_samples_generic_hw_nfa_initials_buckets_fifo #(
...
module nfa_accept_samples_generic_hw_nfa_initials_buckets_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module nfa_accept_samples_generic_hw_nfa_initials_buckets_read/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// nfa_accept_samples_generic_hw_nfa_initials_buckets_read_data_align
nfa_accept_samples_generic_hw_nfa_initials_buckets_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module nfa_accept_samples_generic_hw_nfa_initials_buckets_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// nfa_accept_samples_generic_hw_nfa_initials_buckets_reg_slice
nfa_accept_samples_generic_hw_nfa_initials_buckets_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
