...
nfa_get_finals::nfa_get_finals(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( nfa_finals_buckets_rsp_empty_n );
    sensitive << ( ap_ce );
    sensitive << ( nfa_finals_buckets_read_reg_55 );
    ...
    sc_trace(mVcdFile, nfa_finals_buckets_read_reg_55, "nfa_finals_buckets_read_reg_55");
...
void nfa_get_finals::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(nfa_finals_buckets_rsp_empty_n.read(), ap_const_logic_0)) || !esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read())))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && esl_seteq<1,1,1>(ap_ST_pp0_stg1_fsm_1, ap_CS_fsm.read()) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && esl_seteq<1,1,1>(nfa_finals_buckets_rsp_empty_n.read(), ap_const_logic_0)) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
        nfa_finals_buckets_read_reg_55 = nfa_finals_buckets_datain.read();
    }
}
...
void nfa_get_finals::thread_ap_return_0() {
    ap_return_0 = nfa_finals_buckets_read_reg_55.read();
}
...
void nfa_get_finals::thread_ap_sig_bdd_119() {
    ap_sig_bdd_119 = (esl_seteq<1,1,1>(ap_ST_pp0_stg1_fsm_1, ap_CS_fsm.read()) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && esl_seteq<1,1,1>(nfa_finals_buckets_rsp_empty_n.read(), ap_const_logic_0)));
}
...
void nfa_get_finals::thread_ap_NS_fsm() {
  ...
  esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && 
  esl_seteq<1,1,1>(nfa_finals_buckets_rsp_empty_n.read(), ap_const_logic_0))) && !esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_pprstidle_pp0.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_reg_ppiten_pp0_it1.read()) && esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read())))) {
