...
begin : ap_ret_grp_sample_iterator_next_fu_209_ap_start_ap_start_reg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st27_fsm_26 == ap_NS_fsm) & ((ap_ST_st19_fsm_18 == ap_CS_fsm) | (ap_ST_st26_fsm_25 == ap_CS_fsm)))) begin
...
always @(posedge ap_clk)
begin
    if (((ap_ST_st27_fsm_26 == ap_CS_fsm) & (or_cond_reg_343 == ap_const_lv1_0))) begin
        c_fu_92 <= c_1_reg_347;
...
always @(posedge ap_clk)
begin
    if (((ap_ST_st19_fsm_18 == ap_CS_fsm) & ~(stop_on_first_read_read_fu_102_p2 == ap_const_lv1_0) & (or_cond_fu_245_p2 == ap_const_lv1_0))) begin
...
begin
    if (((ap_ST_st34_fsm_33 == ap_CS_fsm) | (ap_ST_st27_fsm_26 == ap_CS_fsm) | (ap_ST_st28_fsm_27 == ap_CS_fsm) | (ap_ST_st29_fsm_28 == ap_CS_fsm) | (ap_ST_st30_fsm_29 == ap_CS_fsm) | (ap_ST_st31_fsm_30 == ap_CS_fsm) | (ap_ST_st32_fsm_31 == ap_CS_fsm) | (ap_ST_st33_fsm_32 == ap_CS_fsm))) begin
        indices_begin_address = grp_sample_iterator_next_fu_209_indices_begin_address;
