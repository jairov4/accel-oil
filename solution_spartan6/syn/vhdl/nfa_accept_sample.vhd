...
architecture behav of nfa_accept_sample is 
    ...
    signal tmp_2_i_fu_420_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_i_reg_612 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_2_1_i_fu_426_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_1_i_reg_626 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_18_i_cast_fu_444_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_18_i_cast_reg_650 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_17_i_reg_680 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_5_i_cast_fu_493_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_i_cast_fu_511_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_5_i_fu_486_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_6_i_fu_504_p3 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st20_fsm_19 = ap_CS_fsm) and (tmp_2_1_i_reg_626 = ap_const_lv1_0))) then 
                agg_result_bucket_index_0_lcssa4_i_reg_190 <= ap_const_lv1_1;
            elsif (((ap_ST_st19_fsm_18 = ap_CS_fsm) and not((sample_rsp_empty_n = ap_const_logic_0)) and (tmp_2_i_reg_612 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_st19_fsm_18 = ap_CS_fsm) and not((sample_rsp_empty_n = ap_const_logic_0)) and not((tmp_2_i_reg_612 = ap_const_lv1_0)))) then
    ...
    tmp_18_i_cast_reg_650(13 downto 8) <= "000000";

    -- the next state (ap_NS_fsm) of the state machine. --
    ap_NS_fsm_assign_proc : process (ap_start , ap_CS_fsm , nfa_forward_buckets_rsp_empty_n , sample_rsp_empty_n , tmp_s_reg_597 , tmp_2_i_reg_612 , tmp_2_1_i_reg_626 , j_end_phi_fu_312_p4 , any_phi_fu_324_p4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st19_fsm_18 => 
                if ((not((sample_rsp_empty_n = ap_const_logic_0)) and (tmp_2_i_reg_612 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_st21_fsm_20;
                elsif ((not((sample_rsp_empty_n = ap_const_logic_0)) and not((tmp_2_i_reg_612 = ap_const_lv1_0)))) then
                    ap_NS_fsm <= ap_ST_st20_fsm_19;
                else
                    ap_NS_fsm <= ap_ST_st19_fsm_18;
                end if;
            when ap_ST_st20_fsm_19 => 
                if (not((tmp_2_1_i_reg_626 = ap_const_lv1_0))) then
    ...
    grp_fu_482_p0 <= tmp_17_i_reg_680;
    grp_fu_482_p1 <= tmp_18_i_cast_reg_650;
    ...
    nfa_forward_buckets_address_assign_proc : process(ap_CS_fsm, nfa_forward_buckets_rsp_empty_n, tmp_5_i_cast_fu_493_p1, tmp_6_i_cast_fu_511_p1)
    begin
        if (((ap_ST_st36_fsm_35 = ap_CS_fsm) and not((nfa_forward_buckets_rsp_empty_n = ap_const_logic_0)))) then 
    ...
    tmp_18_i_cast_fu_444_p1 <= std_logic_vector(resize(unsigned(sym_reg_621),14));
    tmp_1_fu_568_p2 <= (current_buckets_1_1_reg_746 or current_buckets_0_1_reg_741);
    tmp_2_1_i_fu_426_p2 <= "1" when (next_buckets_1_reg_158 = ap_const_lv32_0) else "0";
    tmp_2_fu_572_p2 <= "0" when (tmp_1_reg_751 = ap_const_lv32_0) else "1";
    tmp_2_i_fu_420_p2 <= "1" when (next_buckets_0_reg_168 = ap_const_lv32_0) else "0";
    tmp_5_fu_447_p1 <= j_bucket_index1_reg_289(1 - 1 downto 0);
    tmp_5_i_cast_fu_493_p1 <= std_logic_vector(resize(unsigned(tmp_5_i_fu_486_p3),32));
    tmp_5_i_fu_486_p3 <= (offset_i_reg_685 & ap_const_lv1_0);
    tmp_6_i_cast_fu_511_p1 <= std_logic_vector(resize(unsigned(tmp_6_i_fu_504_p3),32));
    tmp_6_i_fu_504_p3 <= (offset_i_reg_685 & ap_const_lv1_1);
