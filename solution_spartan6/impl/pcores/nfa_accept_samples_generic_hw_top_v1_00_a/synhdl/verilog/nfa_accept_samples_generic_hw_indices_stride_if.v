...
module nfa_accept_samples_generic_hw_indices_stride_if/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// nfa_accept_samples_generic_hw_indices_stride_request_preprocessor
nfa_accept_samples_generic_hw_indices_stride_request_preprocessor #(
...
// nfa_accept_samples_generic_hw_indices_stride_write
nfa_accept_samples_generic_hw_indices_stride_write #(
...
// nfa_accept_samples_generic_hw_indices_stride_read
nfa_accept_samples_generic_hw_indices_stride_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
...
module nfa_accept_samples_generic_hw_indices_stride_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module nfa_accept_samples_generic_hw_indices_stride_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module nfa_accept_samples_generic_hw_indices_stride_read/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module nfa_accept_samples_generic_hw_indices_stride_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
