...
@.str11 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=175 type=[1 x i8]*]
...
; <label>:4                                       ; preds = %2
  %tmp.3 = add i32 %r.bucket, -1, !dbg !69        ; [#uses=1 type=i32] [debug line = 215:2]
  %bus.assign = and i32 %tmp.3, %r.bucket, !dbg !69 ; [#uses=3 type=i32] [debug line = 215:2]
  %tmp.5 = icmp eq i32 %bus.assign, 0, !dbg !70   ; [#uses=1 type=i1] [debug line = 216:2]
  br i1 %tmp.5, label %.preheader, label %5, !dbg !70 ; [debug line = 216:2]
...
.preheader:                                       ; preds = %4
  ...
  %tmp.9.1 = icmp eq i2 %r.bucket_index.cast1, 0, !dbg !90 ; [#uses=1 type=i1] [debug line = 224:3]
  br i1 %tmp.9.1, label %7, label %.loopexit, !dbg !90 ; [debug line = 224:3]

; <label>:7                                       ; preds = %.preheader
  %tmp.11.1 = icmp eq i32 %.read, 0, !dbg !91     ; [#uses=1 type=i1] [debug line = 227:4]
  br i1 %tmp.11.1, label %.loopexit, label %6, !dbg !91 ; [debug line = 227:4]
...
define i32 @nfa_accept_samples_generic_hw(i32* %nfa.initials.buckets, i32* %nfa.finals.buckets, i32* %nfa.forward.buckets, [16065 x [2 x i32]]* %nfa.backward.buckets, i8* %nfa.symbols, i8* %sample_buffer, i32 %sample_buffer_length, i16 %sample_length, i32* %indices.begin, i16* %indices.samples, i8* %indices.stride, i16 %i_size, i16 %begin.index, i16 %begin.sample, i16 %end.index, i16 %end.sample, i1 %stop_on_first, i1 %accept) {
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str11) nounwind, !dbg !297 ; [debug line = 341:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.initials.buckets, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11), !dbg !299 ; [debug line = 343:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.finals.buckets, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11), !dbg !300 ; [debug line = 344:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.forward.buckets, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11), !dbg !301 ; [debug line = 345:1]
  call void (...)* @_ssdm_op_SpecWire(i8* %nfa.symbols, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !302 ; [debug line = 346:1]
  call void (...)* @_ssdm_op_SpecBus(i8* %sample_buffer, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11), !dbg !303 ; [debug line = 347:1]
  call void (...)* @_ssdm_op_SpecWire(i32 %sample_buffer_length, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !304 ; [debug line = 348:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %sample_length, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !305 ; [debug line = 349:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %indices.begin, i16* %indices.samples, i8* %indices.stride, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11), !dbg !306 ; [debug line = 350:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %i_size, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !307 ; [debug line = 351:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %begin.index, i16 %begin.sample, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !308 ; [debug line = 352:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %end.index, i16 %end.sample, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !309 ; [debug line = 353:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %stop_on_first, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !310 ; [debug line = 354:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %accept, [8 x i8]* @.str36, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !311 ; [debug line = 355:1]
  call void (...)* @_ssdm_op_SpecWire(i32 0, [11 x i8]* @.str37, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind, !dbg !312 ; [debug line = 356:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.initials.buckets, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11), !dbg !313 ; [debug line = 358:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.finals.buckets, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11), !dbg !314 ; [debug line = 359:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.forward.buckets, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11), !dbg !315 ; [debug line = 360:1]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %nfa.symbols, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !316 ; [debug line = 361:1]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %sample_buffer, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11), !dbg !317 ; [debug line = 362:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 %sample_buffer_length, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !318 ; [debug line = 363:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %sample_length, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !319 ; [debug line = 364:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %indices.begin, i16* %indices.samples, i8* %indices.stride, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11), !dbg !320 ; [debug line = 365:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %i_size, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !321 ; [debug line = 366:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %begin.index, i16 %begin.sample, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !322 ; [debug line = 367:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %end.index, i16 %end.sample, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !323 ; [debug line = 368:1]
  call void (...)* @_ssdm_op_SpecIFCore(i1 %stop_on_first, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !324 ; [debug line = 369:1]
  call void (...)* @_ssdm_op_SpecIFCore(i1 %accept, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !325 ; [debug line = 370:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40), !dbg !326 ; [debug line = 371:1]
...
; <label>:1                                       ; preds = %._crit_edge3, %0
  ...
  call void @llvm.dbg.value(metadata !{i16 %i.sample}, i64 0, metadata !333), !dbg !336 ; [debug line = 375:55] [debug variable = i.sample]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %end.index, i16 %end.sample, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40)
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 65535, i32 2000, [1 x i8]* @.str11) nounwind, !dbg !345 ; [debug line = 377:1]
...
define internal fastcc i1 @nfa_accept_sample(i32* %nfa.initials.buckets, i32* %nfa.finals.buckets, i32* nocapture %nfa.forward.buckets, i8* %nfa.symbols, i8* %sample, i32, i16 zeroext %length) {
  call void (...)* @_ssdm_op_SpecIFCore(i8* %sample, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.forward.buckets, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i8* %sample, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.forward.buckets, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  %sample.addr = getelementptr i8* %sample, i32 %0 ; [#uses=1 type=i8*]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %nfa.symbols, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40)
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.finals.buckets, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.initials.buckets, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.finals.buckets, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.initials.buckets, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i16 %length, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40)
  call void (...)* @_ssdm_op_SpecBus(i8* %sample.addr, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11) nounwind
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str11) nounwind, !dbg !371 ; [debug line = 271:1]
...
; <label>:3                                       ; preds = %2
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !382 ; [#uses=1 type=i32] [debug line = 282:3]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1024, i32 512, [1 x i8]* @.str11) nounwind, !dbg !384 ; [debug line = 284:1]
  ...
  %tmp.2.i = icmp eq i32 %"next.buckets[0]", 0, !dbg !387 ; [#uses=1 type=i1] [debug line = 197:3@291:12]
  br i1 %tmp.2.i, label %5, label %4, !dbg !387   ; [debug line = 197:3@291:12]
...
; <label>:5                                       ; preds = %3
  %tmp.2.1.i = icmp eq i32 %"next.buckets[1]", 0, !dbg !387 ; [#uses=1 type=i1] [debug line = 197:3@291:12]
  br i1 %tmp.2.1.i, label %bitset_first.exit, label %4, !dbg !387 ; [debug line = 197:3@291:12]
...
bitset_element.exit:                              ; preds = %bitset_first.exit
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str13), !dbg !417 ; [#uses=1 type=i32] [debug line = 292:4]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 64, i32 5, [1 x i8]* @.str11) nounwind, !dbg !419 ; [debug line = 294:1]
...
; <label>:7                                       ; preds = %bitset_element.exit
  ...
  %tmp.14.i = icmp ugt i8 %nfa.symbols.load, %sym, !dbg !451 ; [#uses=1 type=i1] [debug line = 97:10@296:4]
  br i1 %tmp.14.i, label %nfa_get_sucessors.exit, label %8, !dbg !451 ; [debug line = 97:10@296:4]
...
nfa_get_sucessors.exit:                           ; preds = %7
  %tmp.15.i.cast = zext i6 %state to i14          ; [#uses=1 type=i14]
  %tmp.16.i.cast = zext i8 %nfa.symbols.load to i14 ; [#uses=1 type=i14]
  %tmp.17.i = mul i14 %tmp.16.i.cast, %tmp.15.i.cast ; [#uses=1 type=i14]
  %tmp.18.i.cast = zext i8 %sym to i14            ; [#uses=1 type=i14]
  %offset.i = add i14 %tmp.17.i, %tmp.18.i.cast   ; [#uses=1 type=i14]
  %offset2.i.cast = zext i14 %offset.i to i15     ; [#uses=1 type=i15]
  %tmp.5.i = shl nuw i15 %offset2.i.cast, 1       ; [#uses=2 type=i15]
  %tmp.5.i.cast = zext i15 %tmp.5.i to i32        ; [#uses=1 type=i32]
  %nfa.forward.buckets.addr = getelementptr i32* %nfa.forward.buckets, i32 %tmp.5.i.cast ; [#uses=1 type=i32*]
  %"tmp.buckets[0].2" = load i32* %nfa.forward.buckets.addr, align 4, !dbg !455 ; [#uses=1 type=i32] [debug line = 100:2@296:4]
  %tmp.6.i = or i15 %tmp.5.i, 1                   ; [#uses=1 type=i15]
  %tmp.6.i.cast = zext i15 %tmp.6.i to i32        ; [#uses=1 type=i32]
  %nfa.forward.buckets.addr.1 = getelementptr i32* %nfa.forward.buckets, i32 %tmp.6.i.cast ; [#uses=1 type=i32*]
  ...
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str13, i32 %tmp.4), !dbg !471 ; [#uses=0 type=i32] [debug line = 299:3]
...
; <label>:11                                      ; preds = %10
  ...
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1].3"}, i64 0, metadata !379), !dbg !484 ; [debug line = 305:3] [debug variable = current.buckets[1]]
  %12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp), !dbg !485 ; [#uses=0 type=i32] [debug line = 306:2]
...
define internal fastcc { i16, i16 } @sample_iterator_next(i32* %indices.begin, i16* %indices.samples, i8* %indices.stride, i16 %i.index, i16 %i.sample) readonly {
  call void (...)* @_ssdm_op_SpecIFCore(i8* %indices.stride, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i32* %indices.begin, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i8* %indices.stride, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i32* %indices.begin, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i16* %indices.samples, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i16* %indices.samples, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  ...
  %tmp. = zext i16 %i.index to i32, !dbg !512     ; [#uses=1 type=i32] [debug line = 242:2]
  %indices.samples.addr = getelementptr i16* %indices.samples, i32 %tmp. ; [#uses=1 type=i16*]
  %indices.samples.load = load i16* %indices.samples.addr, align 2, !dbg !512 ; [#uses=1 type=i16] [debug line = 242:2]
  %tmp.4.cast = zext i16 %indices.samples.load to i17, !dbg !512 ; [#uses=1 type=i17] [debug line = 242:2]
  %tmp.5 = add i17 %tmp.4.cast, -1, !dbg !512     ; [#uses=1 type=i17] [debug line = 242:2]
  %tmp.5.cast = sext i17 %tmp.5 to i18, !dbg !512 ; [#uses=1 type=i18] [debug line = 242:2]
  %tmp.6 = icmp slt i18 %tmp.cast, %tmp.5.cast, !dbg !512 ; [#uses=2 type=i1] [debug line = 242:2]
  %tmp.7 = add i16 %i.index, 1, !dbg !514         ; [#uses=1 type=i16] [debug line = 246:3]
  %tmp.8 = add i16 %i.sample, 1, !dbg !516        ; [#uses=1 type=i16] [debug line = 244:3]
  %agg.result.sample.write.assign = select i1 %tmp.6, i16 %tmp.8, i16 0, !dbg !512 ; [#uses=1 type=i16] [debug line = 242:2]
  %agg.result.index.write.assign = select i1 %tmp.6, i16 %i.index, i16 %tmp.7, !dbg !512 ; [#uses=1 type=i16] [debug line = 242:2]
...
define internal fastcc i32 @sample_iterator_get_offset(i16 %i.index, i16 %i.sample, i32* %indices.begin, i16* %indices.samples, i8* %indices.stride, i32 %sample_buffer_size, i16 zeroext %sample_length) {
  call void (...)* @_ssdm_op_SpecIFCore(i16* %indices.samples, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecBus(i16* %indices.samples, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i32* %indices.begin, i8* %indices.stride, [1 x i8]* @.str11, [7 x i8]* @.str38, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11)
  call void (...)* @_ssdm_op_SpecIFCore(i16 %sample_length, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %sample_buffer_size, [1 x i8]* @.str11, [7 x i8]* @.str39, [1 x i8]* @.str11, [1 x i8]* @.str11, [1 x i8]* @.str11, [17 x i8]* @.str40)
  call void (...)* @_ssdm_op_SpecBus(i32* %indices.begin, i8* %indices.stride, [7 x i8]* @.str35, i32 0, i32 0, i32 0, [1 x i8]* @.str11)
  ...
  %tmp.9.cast = zext i16 %i.sample to i24, !dbg !537 ; [#uses=1 type=i24] [debug line = 261:79]
  %tmp.1 = mul i24 %tmp.9.cast, %tmp..cast, !dbg !537 ; [#uses=1 type=i24] [debug line = 261:79]
  %tmp.1.cast = zext i24 %tmp.1 to i32, !dbg !537 ; [#uses=1 type=i32] [debug line = 261:79]
  %offset = add i32 %tmp.1.cast, %indices.begin.load, !dbg !537 ; [#uses=2 type=i32] [debug line = 261:79]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !539), !dbg !537 ; [debug line = 261:79] [debug variable = offset]
  %tmp.2 = zext i16 %sample_length to i32, !dbg !540 ; [#uses=1 type=i32] [debug line = 262:2]
  %tmp.3 = sub i32 %sample_buffer_size, %tmp.2, !dbg !540 ; [#uses=1 type=i32] [debug line = 262:2]
  %tmp.4 = icmp ugt i32 %offset, %tmp.3, !dbg !540 ; [#uses=1 type=i1] [debug line = 262:2]
  br i1 %tmp.4, label %1, label %2, !dbg !540     ; [debug line = 262:2]
...
.preheader.1:                                     ; preds = %.preheader.0
  ...
  %tmp.4.1 = icmp sgt i2 %bus.cast29, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.1, label %.preheader.2, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.2:                                     ; preds = %.preheader.1
  %bus.cast28 = trunc i32 %bus to i3, !dbg !565   ; [#uses=1 type=i3] [debug line = 54:3]
  %tmp.4.2 = icmp sgt i3 %bus.cast28, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.2, label %.preheader.3, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.3:                                     ; preds = %.preheader.2
  %bus.cast27 = trunc i32 %bus to i4, !dbg !565   ; [#uses=1 type=i4] [debug line = 54:3]
  %tmp.4.3 = icmp sgt i4 %bus.cast27, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.3, label %.preheader.4, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.4:                                     ; preds = %.preheader.3
  %bus.cast26 = trunc i32 %bus to i5, !dbg !565   ; [#uses=1 type=i5] [debug line = 54:3]
  %tmp.4.4 = icmp sgt i5 %bus.cast26, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.4, label %.preheader.5, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.5:                                     ; preds = %.preheader.4
  %bus.cast25 = trunc i32 %bus to i6, !dbg !565   ; [#uses=1 type=i6] [debug line = 54:3]
  %tmp.4.5 = icmp sgt i6 %bus.cast25, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.5, label %.preheader.6, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.6:                                     ; preds = %.preheader.5
  %bus.cast24 = trunc i32 %bus to i7, !dbg !565   ; [#uses=1 type=i7] [debug line = 54:3]
  %tmp.4.6 = icmp sgt i7 %bus.cast24, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.6, label %.preheader.7, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.7:                                     ; preds = %.preheader.6
  %bus.cast23 = trunc i32 %bus to i8, !dbg !565   ; [#uses=1 type=i8] [debug line = 54:3]
  %tmp.4.7 = icmp sgt i8 %bus.cast23, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.7, label %.preheader.8, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.8:                                     ; preds = %.preheader.7
  %bus.cast22 = trunc i32 %bus to i9, !dbg !565   ; [#uses=1 type=i9] [debug line = 54:3]
  %tmp.4.8 = icmp sgt i9 %bus.cast22, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.8, label %.preheader.9, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.9:                                     ; preds = %.preheader.8
  %bus.cast21 = trunc i32 %bus to i10, !dbg !565  ; [#uses=1 type=i10] [debug line = 54:3]
  %tmp.4.9 = icmp sgt i10 %bus.cast21, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.9, label %.preheader.10, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.10:                                    ; preds = %.preheader.9
  %bus.cast20 = trunc i32 %bus to i11, !dbg !565  ; [#uses=1 type=i11] [debug line = 54:3]
  %tmp.4. = icmp sgt i11 %bus.cast20, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4., label %.preheader.11, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.11:                                    ; preds = %.preheader.10
  %bus.cast19 = trunc i32 %bus to i12, !dbg !565  ; [#uses=1 type=i12] [debug line = 54:3]
  %tmp.4.10 = icmp sgt i12 %bus.cast19, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.10, label %.preheader.12, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.12:                                    ; preds = %.preheader.11
  %bus.cast18 = trunc i32 %bus to i13, !dbg !565  ; [#uses=1 type=i13] [debug line = 54:3]
  %tmp.4.11 = icmp sgt i13 %bus.cast18, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.11, label %.preheader.13, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.13:                                    ; preds = %.preheader.12
  %bus.cast17 = trunc i32 %bus to i14, !dbg !565  ; [#uses=1 type=i14] [debug line = 54:3]
  %tmp.4.12 = icmp sgt i14 %bus.cast17, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.12, label %.preheader.14, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.14:                                    ; preds = %.preheader.13
  %bus.cast16 = trunc i32 %bus to i15, !dbg !565  ; [#uses=1 type=i15] [debug line = 54:3]
  %tmp.4.13 = icmp sgt i15 %bus.cast16, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.13, label %.preheader.15, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.15:                                    ; preds = %.preheader.14
  %bus.cast15 = trunc i32 %bus to i16, !dbg !565  ; [#uses=1 type=i16] [debug line = 54:3]
  %tmp.4.14 = icmp sgt i16 %bus.cast15, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.14, label %.preheader.16, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.16:                                    ; preds = %.preheader.15
  %bus.cast14 = trunc i32 %bus to i17, !dbg !565  ; [#uses=1 type=i17] [debug line = 54:3]
  %tmp.4.15 = icmp sgt i17 %bus.cast14, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.15, label %.preheader.17, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.17:                                    ; preds = %.preheader.16
  %bus.cast13 = trunc i32 %bus to i18, !dbg !565  ; [#uses=1 type=i18] [debug line = 54:3]
  %tmp.4.16 = icmp sgt i18 %bus.cast13, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.16, label %.preheader.18, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.18:                                    ; preds = %.preheader.17
  %bus.cast12 = trunc i32 %bus to i19, !dbg !565  ; [#uses=1 type=i19] [debug line = 54:3]
  %tmp.4.17 = icmp sgt i19 %bus.cast12, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.17, label %.preheader.19, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.19:                                    ; preds = %.preheader.18
  %bus.cast11 = trunc i32 %bus to i20, !dbg !565  ; [#uses=1 type=i20] [debug line = 54:3]
  %tmp.4.18 = icmp sgt i20 %bus.cast11, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.18, label %.preheader.20, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.20:                                    ; preds = %.preheader.19
  %bus.cast10 = trunc i32 %bus to i21, !dbg !565  ; [#uses=1 type=i21] [debug line = 54:3]
  %tmp.4.19 = icmp sgt i21 %bus.cast10, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.19, label %.preheader.21, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.21:                                    ; preds = %.preheader.20
  %bus.cast9 = trunc i32 %bus to i22, !dbg !565   ; [#uses=1 type=i22] [debug line = 54:3]
  %tmp.4.20 = icmp sgt i22 %bus.cast9, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.20, label %.preheader.22, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.22:                                    ; preds = %.preheader.21
  %bus.cast8 = trunc i32 %bus to i23, !dbg !565   ; [#uses=1 type=i23] [debug line = 54:3]
  %tmp.4.21 = icmp sgt i23 %bus.cast8, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.21, label %.preheader.23, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.23:                                    ; preds = %.preheader.22
  %bus.cast7 = trunc i32 %bus to i24, !dbg !565   ; [#uses=1 type=i24] [debug line = 54:3]
  %tmp.4.22 = icmp sgt i24 %bus.cast7, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.22, label %.preheader.24, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.24:                                    ; preds = %.preheader.23
  %bus.cast6 = trunc i32 %bus to i25, !dbg !565   ; [#uses=1 type=i25] [debug line = 54:3]
  %tmp.4.23 = icmp sgt i25 %bus.cast6, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.23, label %.preheader.25, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.25:                                    ; preds = %.preheader.24
  %bus.cast5 = trunc i32 %bus to i26, !dbg !565   ; [#uses=1 type=i26] [debug line = 54:3]
  %tmp.4.24 = icmp sgt i26 %bus.cast5, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.24, label %.preheader.26, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.26:                                    ; preds = %.preheader.25
  %bus.cast4 = trunc i32 %bus to i27, !dbg !565   ; [#uses=1 type=i27] [debug line = 54:3]
  %tmp.4.25 = icmp sgt i27 %bus.cast4, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.25, label %.preheader.27, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.27:                                    ; preds = %.preheader.26
  %bus.cast3 = trunc i32 %bus to i28, !dbg !565   ; [#uses=1 type=i28] [debug line = 54:3]
  %tmp.4.26 = icmp sgt i28 %bus.cast3, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.26, label %.preheader.28, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.28:                                    ; preds = %.preheader.27
  %bus.cast2 = trunc i32 %bus to i29, !dbg !565   ; [#uses=1 type=i29] [debug line = 54:3]
  %tmp.4.27 = icmp sgt i29 %bus.cast2, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.27, label %.preheader.29, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.29:                                    ; preds = %.preheader.28
  %bus.cast1 = trunc i32 %bus to i30, !dbg !565   ; [#uses=1 type=i30] [debug line = 54:3]
  %tmp.4.28 = icmp sgt i30 %bus.cast1, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.28, label %.preheader.30, label %.loopexit, !dbg !565 ; [debug line = 54:3]

.preheader.30:                                    ; preds = %.preheader.29
  %bus.cast = trunc i32 %bus to i31, !dbg !565    ; [#uses=1 type=i31] [debug line = 54:3]
  %tmp.4.29 = icmp sgt i31 %bus.cast, -1, !dbg !565 ; [#uses=1 type=i1] [debug line = 54:3]
  br i1 %tmp.4.29, label %.preheader.31, label %.loopexit, !dbg !565 ; [debug line = 54:3]
...
!27 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/Design/XilinxHLS_ws/oil_plainc_hls/solution_spartan6/.autopilot/db/bitset.pragma.2.c", metadata !"c:/Design/XilinxHLS_ws", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, null, null, null, metadata !28} ; [ DW_TAG_compile_unit ]
