...
upvar ::AESL_AUTOSIM::DirAutoSimRoot  DirAutoSimRoot
    ...
    set gWorkingDir             "../.."
    set constFileTvIn           "nfa_accept_samples_generic_hw.autotvin.dat"
    set constFileTvOut          "nfa_accept_samples_generic_hw.autotvout.dat"
    set constFileHdlTvIn        "nfa_accept_samples_generic_hw.autohdltvin.dat"
    set constFileHdlTvOut       "nfa_accept_samples_generic_hw.autohdltvout.dat"
    set gGateLevelSim           "0"
    set gAutowrap               "1"
    set gTool                   "modelsim"
