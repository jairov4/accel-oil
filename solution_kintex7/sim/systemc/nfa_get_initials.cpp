...
const sc_lv<64> nfa_get_initials::ap_const_lv64_1 = "1";
...
nfa_get_initials::nfa_get_initials(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( nfa_initials_buckets_rsp_empty_n );
    sensitive << ( ap_ce );
    sensitive << ( nfa_initials_buckets_read_reg_63 );
    ...
    sc_trace(mVcdFile, nfa_initials_buckets_read_reg_63, "nfa_initials_buckets_read_reg_63");
...
void nfa_get_initials::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0)) || !esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read())))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it2.read()) && esl_seteq<1,1,1>(ap_ST_pp0_stg1_fsm_1, ap_CS_fsm.read()) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it2.read()) && esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0)) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
        nfa_initials_buckets_read_reg_63 = nfa_initials_buckets_datain.read();
    }
}
...
void nfa_get_initials::thread_ap_ready() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it0.read()) && 
         ...
         !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it2.read()) && esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
...
void nfa_get_initials::thread_ap_return_0() {
    ap_return_0 = nfa_initials_buckets_read_reg_63.read();
}
...
void nfa_get_initials::thread_ap_sig_bdd_67() {
    ap_sig_bdd_67 = (esl_seteq<1,1,1>(ap_ST_pp0_stg1_fsm_1, ap_CS_fsm.read()) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it2.read()) && esl_seteq<1,1,1>(nfa_initials_buckets_rsp_empty_n.read(), ap_const_logic_0)));
}
...
void nfa_get_initials::thread_nfa_initials_buckets_address() {
    if (ap_sig_bdd_135.read()) {
        if (ap_sig_bdd_67.read()) {
            nfa_initials_buckets_address =  (sc_lv<32>) (ap_const_lv64_1);
