...
struct sample_iterator_get_offset : public sc_module {
    ...
    sc_signal< sc_lv<16> > i_sample_read_reg_131;
    sc_signal< sc_lv<16> > ap_reg_ppstg_i_sample_read_reg_131_pp0_it1;
    sc_signal< sc_lv<16> > ap_reg_ppstg_i_sample_read_reg_131_pp0_it2;
    sc_signal< sc_lv<16> > ap_reg_ppstg_i_sample_read_reg_131_pp0_it3;
    sc_signal< sc_lv<16> > ap_reg_ppstg_i_sample_read_reg_131_pp0_it4;
    sc_signal< sc_lv<16> > ap_reg_ppstg_i_sample_read_reg_131_pp0_it5;
    sc_signal< sc_lv<32> > indices_begin_addr_reg_136;
    sc_signal< sc_lv<32> > ap_reg_ppstg_indices_begin_addr_reg_136_pp0_it1;
    sc_signal< sc_lv<32> > ap_reg_ppstg_indices_begin_addr_reg_136_pp0_it2;
    sc_signal< sc_lv<8> > indices_stride_addr_read_reg_148;
    sc_signal< sc_lv<32> > indices_begin_addr_read_reg_163;
    sc_signal< sc_lv<64> > tmp_fu_93_p1;
    sc_signal< sc_lv<16> > grp_fu_116_p0;
    sc_signal< sc_lv<8> > grp_fu_116_p1;
    sc_signal< sc_lv<24> > grp_fu_116_p2;
    sc_signal< sc_lv<32> > tmp_8_cast_fu_122_p1;
    sc_signal< sc_logic > grp_fu_116_ce;
    sc_signal< sc_lv<1> > ap_NS_fsm;
    sc_signal< sc_logic > ap_sig_pprstidle_pp0;
    sc_signal< sc_lv<24> > grp_fu_116_p00;
    sc_signal< sc_lv<24> > grp_fu_116_p10;
    ...
    void thread_tmp_8_cast_fu_122_p1();
