...
set Library     "hls"
set IPName      "nfa_accept_samples_generic_hw"
set Version     "1.0"
set DisplayName "Nfa_accept_samples_generic_hw"
set Revision    "1404162117"
set Description "An IP generated by Vivado HLS"
set Device      "kintex7"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "nfa_accept_samples_generic_hw_top"
...
set Interfaces {
    M_AXI_NFA_INITIALS_BUCKETS {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_nfa_initials_buckets"
        param_prefix "C_M_AXI_NFA_INITIALS_BUCKETS"
    }
    M_AXI_NFA_FINALS_BUCKETS {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_nfa_finals_buckets"
        param_prefix "C_M_AXI_NFA_FINALS_BUCKETS"
    }
    M_AXI_NFA_FORWARD_BUCKETS {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_nfa_forward_buckets"
        param_prefix "C_M_AXI_NFA_FORWARD_BUCKETS"
    }
    M_AXI_SAMPLE_BUFFER {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_sample_buffer"
        param_prefix "C_M_AXI_SAMPLE_BUFFER"
    }
    M_AXI_INDICES_BEGIN {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_indices_begin"
        param_prefix "C_M_AXI_INDICES_BEGIN"
    }
    M_AXI_INDICES_SAMPLES {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_indices_samples"
        param_prefix "C_M_AXI_INDICES_SAMPLES"
    }
    M_AXI_INDICES_STRIDE {
        type "axi4"
        mode "master"
        data_width "32"
        port_prefix "m_axi_indices_stride"
        param_prefix "C_M_AXI_INDICES_STRIDE"
    }
    S_AXI_SLV0 {
        type "axi4lite"
        mode "slave"
    ...
    aclk {
        type "clock"
        buses "M_AXI_NFA_INITIALS_BUCKETS M_AXI_NFA_FINALS_BUCKETS M_AXI_NFA_FORWARD_BUCKETS M_AXI_SAMPLE_BUFFER M_AXI_INDICES_BEGIN M_AXI_INDICES_SAMPLES M_AXI_INDICES_STRIDE S_AXI_SLV0"
    }
    aresetn {
        type "reset"
    }
