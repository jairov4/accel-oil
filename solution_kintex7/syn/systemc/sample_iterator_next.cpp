...
sample_iterator_next::sample_iterator_next(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_8_fu_63_p1);
    sensitive << ( i_index );
    ...
    sc_trace(mVcdFile, tmp_s_reg_155, "tmp_s_reg_155");
    ...
    sc_trace(mVcdFile, tmp_3_reg_166, "tmp_3_reg_166");
    sc_trace(mVcdFile, grp_fu_88_p2, "grp_fu_88_p2");
    sc_trace(mVcdFile, tmp_2_reg_171, "tmp_2_reg_171");
    sc_trace(mVcdFile, tmp_8_fu_63_p1, "tmp_8_fu_63_p1");
...
void sample_iterator_next::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && 
  esl_seteq<1,1,1>(indices_samples_rsp_empty_n.read(), ap_const_logic_0))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
        tmp_1_reg_160 = tmp_1_fu_99_p2.read();
        tmp_2_reg_171 = grp_fu_88_p2.read();
        tmp_3_reg_166 = grp_fu_83_p2.read();
    }
  ...
  esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && 
  esl_seteq<1,1,1>(indices_samples_rsp_empty_n.read(), ap_const_logic_0))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
        tmp_s_reg_155 = grp_fu_77_p2.read();
    }
}

void sample_iterator_next::thread_agg_result_index_write_assign_fu_111_p3() {
    agg_result_index_write_assign_fu_111_p3 = (!tmp_1_reg_160.read()[0].is_01())? sc_lv<16>(): ((tmp_1_reg_160.read()[0].to_bool())? ap_reg_ppstg_i_index_read_reg_134_pp0_it6.read(): tmp_3_reg_166.read());
}

void sample_iterator_next::thread_agg_result_sample_write_assign_fu_105_p3() {
    agg_result_sample_write_assign_fu_105_p3 = (!tmp_1_reg_160.read()[0].is_01())? sc_lv<16>(): ((tmp_1_reg_160.read()[0].to_bool())? tmp_2_reg_171.read(): ap_const_lv16_0);
}
...
void sample_iterator_next::thread_indices_samples_address() {
    indices_samples_address = tmp_8_fu_63_p1.read();
}
...
void sample_iterator_next::thread_tmp_1_fu_99_p1() {
    tmp_1_fu_99_p1 = esl_sext<18,17>(tmp_s_reg_155.read());
}

void sample_iterator_next::thread_tmp_1_fu_99_p2() {
    tmp_1_fu_99_p2 = (!tmp_cast_fu_93_p1.read().is_01() || !tmp_1_fu_99_p1.read().is_01())? sc_lv<1>(): (sc_bigint<18>(tmp_cast_fu_93_p1.read()) < sc_bigint<18>(tmp_1_fu_99_p1.read()));
}

void sample_iterator_next::thread_tmp_8_fu_63_p1() {
    tmp_8_fu_63_p1 = esl_zext<32,16>(i_index.read());
}
