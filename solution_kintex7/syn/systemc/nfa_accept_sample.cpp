...
nfa_accept_sample::nfa_accept_sample(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_CS_fsm );
    sensitive << ( nfa_forward_buckets_rsp_empty_n );
    sensitive << ( tmp_4_i_cast_fu_493_p1 );
    sensitive << ( tmp_8_i_cast_fu_511_p1 );
    ...
    SC_METHOD(thread_tmp_4_i_cast_fu_493_p1);
    sensitive << ( tmp_4_i_fu_486_p3 );

    SC_METHOD(thread_tmp_4_i_fu_486_p3);
    ...
    SC_METHOD(thread_tmp_8_i_cast_fu_511_p1);
    sensitive << ( tmp_8_i_fu_504_p3 );

    SC_METHOD(thread_tmp_8_i_fu_504_p3);
    sensitive << ( offset_i_reg_685 );
    ...
    sc_trace(mVcdFile, tmp_4_i_cast_fu_493_p1, "tmp_4_i_cast_fu_493_p1");
    sc_trace(mVcdFile, tmp_8_i_cast_fu_511_p1, "tmp_8_i_cast_fu_511_p1");
    ...
    sc_trace(mVcdFile, tmp_4_i_fu_486_p3, "tmp_4_i_fu_486_p3");
    sc_trace(mVcdFile, tmp_8_i_fu_504_p3, "tmp_8_i_fu_504_p3");
...
void nfa_accept_sample::thread_nfa_forward_buckets_address() {
    if ((esl_seteq<1,6,6>(ap_ST_st36_fsm_35, ap_CS_fsm.read()) && 
         !esl_seteq<1,1,1>(nfa_forward_buckets_rsp_empty_n.read(), ap_const_logic_0))) {
        nfa_forward_buckets_address = tmp_8_i_cast_fu_511_p1.read();
    } else if (esl_seteq<1,6,6>(ap_ST_st35_fsm_34, ap_CS_fsm.read())) {
        nfa_forward_buckets_address = tmp_4_i_cast_fu_493_p1.read();
    } else {
...
void nfa_accept_sample::thread_tmp_4_i_cast_fu_493_p1() {
    tmp_4_i_cast_fu_493_p1 = esl_zext<32,15>(tmp_4_i_fu_486_p3.read());
}

void nfa_accept_sample::thread_tmp_4_i_fu_486_p3() {
    tmp_4_i_fu_486_p3 = esl_concat<14,1>(offset_i_reg_685.read(), ap_const_lv1_0);
}
...
void nfa_accept_sample::thread_tmp_8_i_cast_fu_511_p1() {
    tmp_8_i_cast_fu_511_p1 = esl_zext<32,15>(tmp_8_i_fu_504_p3.read());
}

void nfa_accept_sample::thread_tmp_8_i_fu_504_p3() {
    tmp_8_i_fu_504_p3 = esl_concat<14,1>(offset_i_reg_685.read(), ap_const_lv1_1);
}
