...
wire   [31:0] tmp_4_i_cast_fu_493_p1;
wire   [31:0] tmp_8_i_cast_fu_511_p1;
...
wire   [14:0] tmp_4_i_fu_486_p3;
wire   [14:0] tmp_8_i_fu_504_p3;
wire    grp_fu_392_ce;
wire    grp_fu_402_ce;
reg    grp_fu_414_ce;
wire    grp_fu_463_ce;
...
always @ (ap_CS_fsm or nfa_forward_buckets_rsp_empty_n or tmp_4_i_cast_fu_493_p1 or tmp_8_i_cast_fu_511_p1)
begin
    if (((ap_ST_st36_fsm_35 == ap_CS_fsm) & ~(nfa_forward_buckets_rsp_empty_n == ap_const_logic_0))) begin
...
assign tmp_4_i_cast_fu_493_p1 = $unsigned(tmp_4_i_fu_486_p3);
assign tmp_4_i_fu_486_p3 = {{offset_i_reg_685}, {ap_const_lv1_0}};
assign tmp_5_fu_447_p1 = j_bucket_index1_reg_289[0:0];
assign tmp_7_i_cast_fu_444_p1 = $unsigned(sym_reg_621);
assign tmp_8_i_cast_fu_511_p1 = $unsigned(tmp_8_i_fu_504_p3);
assign tmp_8_i_fu_504_p3 = {{offset_i_reg_685}, {ap_const_lv1_1}};
