...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("indices_begin_req_din", 1, hls_out, 8, "ap_bus", "fifo_data", 1),
	Port_Property("indices_begin_req_full_n", 1, hls_in, 8, "ap_bus", "fifo_status", 1),
	Port_Property("indices_begin_req_write", 1, hls_out, 8, "ap_bus", "fifo_update", 1),
	Port_Property("indices_begin_rsp_empty_n", 1, hls_in, 8, "ap_bus", "fifo_status", 1),
	Port_Property("indices_begin_rsp_read", 1, hls_out, 8, "ap_bus", "fifo_update", 1),
	Port_Property("indices_begin_address", 32, hls_out, 8, "ap_bus", "unknown", 1),
	Port_Property("indices_begin_datain", 32, hls_in, 8, "ap_bus", "unknown", 1),
	Port_Property("indices_begin_dataout", 32, hls_out, 8, "ap_bus", "unknown", 1),
	Port_Property("indices_begin_size", 32, hls_out, 8, "ap_bus", "unknown", 1),
	Port_Property("indices_samples_req_din", 1, hls_out, 9, "ap_bus", "fifo_data", 1),
	Port_Property("indices_samples_req_full_n", 1, hls_in, 9, "ap_bus", "fifo_status", 1),
	Port_Property("indices_samples_req_write", 1, hls_out, 9, "ap_bus", "fifo_update", 1),
	Port_Property("indices_samples_rsp_empty_n", 1, hls_in, 9, "ap_bus", "fifo_status", 1),
	Port_Property("indices_samples_rsp_read", 1, hls_out, 9, "ap_bus", "fifo_update", 1),
	Port_Property("indices_samples_address", 32, hls_out, 9, "ap_bus", "unknown", 1),
	Port_Property("indices_samples_datain", 16, hls_in, 9, "ap_bus", "unknown", 1),
	Port_Property("indices_samples_dataout", 16, hls_out, 9, "ap_bus", "unknown", 1),
	Port_Property("indices_samples_size", 32, hls_out, 9, "ap_bus", "unknown", 1),
	Port_Property("indices_stride_req_din", 1, hls_out, 10, "ap_bus", "fifo_data", 1),
	Port_Property("indices_stride_req_full_n", 1, hls_in, 10, "ap_bus", "fifo_status", 1),
	Port_Property("indices_stride_req_write", 1, hls_out, 10, "ap_bus", "fifo_update", 1),
	Port_Property("indices_stride_rsp_empty_n", 1, hls_in, 10, "ap_bus", "fifo_status", 1),
	Port_Property("indices_stride_rsp_read", 1, hls_out, 10, "ap_bus", "fifo_update", 1),
	Port_Property("indices_stride_address", 32, hls_out, 10, "ap_bus", "unknown", 1),
	Port_Property("indices_stride_datain", 8, hls_in, 10, "ap_bus", "unknown", 1),
	Port_Property("indices_stride_dataout", 8, hls_out, 10, "ap_bus", "unknown", 1),
	Port_Property("indices_stride_size", 32, hls_out, 10, "ap_bus", "unknown", 1),
	Port_Property("i_size", 16, hls_in, 11, "ap_none", "in_data", 1),
	Port_Property("begin_index", 16, hls_in, 12, "ap_none", "in_data", 1),
	Port_Property("begin_sample", 16, hls_in, 13, "ap_none", "in_data", 1),
	Port_Property("end_index", 16, hls_in, 14, "ap_none", "in_data", 1),
	Port_Property("end_sample", 16, hls_in, 15, "ap_none", "in_data", 1),
	Port_Property("stop_on_first", 1, hls_in, 16, "ap_none", "in_data", 1),
	Port_Property("accept", 1, hls_in, 17, "ap_none", "in_data", 1),
