set moduleName nfa_get_initials_1
...
set pipeII 1
set pipeLatency 3
set C_modelName nfa_get_initials.1
set C_modelType { void 0 }
set C_modelArgList { 
	{ nfa_initials_buckets int 64 regular {bus 0}  }
	{ initials_buckets int 64 regular {array 16 { 0 3 } 0 1 }  }
	{ tmp_s int 5 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "nfa_initials_buckets", "interface" : "bus", "bitwidth" : 64} , 
 	{ "Name" : "initials_buckets", "interface" : "memory", "bitwidth" : 64} , 
 	{ "Name" : "tmp_s", "interface" : "wire", "bitwidth" : 5} ]}
...
set portList { 
	...
	{ initials_buckets_address0 sc_out sc_lv 4 signal 1 } 
	{ initials_buckets_ce0 sc_out sc_logic 1 signal 1 } 
	{ initials_buckets_we0 sc_out sc_logic 1 signal 1 } 
	{ initials_buckets_d0 sc_out sc_lv 64 signal 1 } 
	{ tmp_s sc_in sc_lv 5 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "initials_buckets_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "initials_buckets", "role": "address0" }} , 
 	{ "name": "initials_buckets_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "initials_buckets", "role": "ce0" }} , 
 	{ "name": "initials_buckets_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "initials_buckets", "role": "we0" }} , 
 	{ "name": "initials_buckets_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "initials_buckets", "role": "d0" }} , 
 	{ "name": "tmp_s", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "tmp_s", "role": "default" }}  ]}
set Spec2ImplPortList { 
	...
	initials_buckets { ap_memory {  { initials_buckets_address0 mem_address 1 4 }  { initials_buckets_ce0 mem_ce 1 1 }  { initials_buckets_we0 mem_we 1 1 }  { initials_buckets_d0 mem_din 1 64 } } }
	tmp_s { ap_none {  { tmp_s in_data 0 5 } } }
}
