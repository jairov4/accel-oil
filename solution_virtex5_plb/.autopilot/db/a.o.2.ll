...
@.str212 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=179 type=[1 x i8]*]
...
@.str12 = private unnamed_addr constant [12 x i8] c"hls_label_0\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
@.str31 = private unnamed_addr constant [7 x i8] c"PLB46M\00", align 1 ; [#uses=12 type=[7 x i8]*]
...
@.str34 = private unnamed_addr constant [12 x i8] c"hls_label_2\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
._crit_edge2:                                     ; preds = %._crit_edge1
  %tmp.3 = add i32 %r.bucket, -1, !dbg !42        ; [#uses=1 type=i32] [debug line = 217:2]
  %bus.assign = and i32 %tmp.3, %r.bucket, !dbg !42 ; [#uses=3 type=i32] [debug line = 217:2]
  %tmp.5 = icmp eq i32 %bus.assign, 0, !dbg !43   ; [#uses=1 type=i1] [debug line = 218:2]
  br i1 %tmp.5, label %.preheader, label %2, !dbg !43 ; [debug line = 218:2]
...
.preheader:                                       ; preds = %._crit_edge2
  ...
  %tmp.9.1 = icmp eq i2 %r.bucket_index.cast1, 0, !dbg !63 ; [#uses=1 type=i1] [debug line = 226:3]
  br i1 %tmp.9.1, label %4, label %.loopexit, !dbg !63 ; [debug line = 226:3]

; <label>:4                                       ; preds = %.preheader
  %tmp.11.1 = icmp eq i32 %.read, 0, !dbg !64     ; [#uses=1 type=i1] [debug line = 229:4]
  br i1 %tmp.11.1, label %.loopexit, label %3, !dbg !64 ; [debug line = 229:4]
...
define i32 @nfa_accept_samples_generic_hw(i32* %nfa.initials.buckets, i32* %nfa.finals.buckets, i32* %nfa.forward.buckets, [16065 x [2 x i32]]* %nfa.backward.buckets, i8* %nfa.symbols, i8* %sample_buffer, i32 %sample_buffer_length, i16 zeroext %sample_length, i56* %indices, i16 zeroext %i_size, i16 %begin.index, i16 %begin.sample, i16 %end.index, i16 %end.sample, i1 zeroext %stop_on_first, i1 zeroext %accept) {
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str212) nounwind, !dbg !269 ; [debug line = 358:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.initials.buckets, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !271 ; [debug line = 361:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.finals.buckets, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !272 ; [debug line = 362:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.forward.buckets, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !273 ; [debug line = 363:1]
  call void (...)* @_ssdm_op_SpecWire(i8* %nfa.symbols, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !274 ; [debug line = 364:1]
  call void (...)* @_ssdm_op_SpecBus(i8* %sample_buffer, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecWire(i32 %sample_buffer_length, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !275 ; [debug line = 366:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %sample_length, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !276 ; [debug line = 367:1]
  call void (...)* @_ssdm_op_SpecBus(i56* %indices, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecWire(i16 %i_size, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !277 ; [debug line = 369:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %begin.index, i16 %begin.sample, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !278 ; [debug line = 370:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %end.index, i16 %end.sample, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !279 ; [debug line = 371:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %stop_on_first, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !280 ; [debug line = 372:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %accept, [8 x i8]* @.str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !281 ; [debug line = 373:1]
  call void (...)* @_ssdm_op_SpecWire(i32 0, [11 x i8]* @.str30, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212) nounwind, !dbg !282 ; [debug line = 374:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.initials.buckets, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !283 ; [debug line = 381:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.finals.buckets, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !284 ; [debug line = 382:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.forward.buckets, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !285 ; [debug line = 383:1]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %nfa.symbols, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !286 ; [debug line = 385:1]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %sample_buffer, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212), !dbg !287 ; [debug line = 386:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 %sample_buffer_length, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !288 ; [debug line = 387:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %sample_length, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !289 ; [debug line = 388:1]
  call void (...)* @_ssdm_op_SpecIFCore(i56* %indices, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecIFCore(i16 %i_size, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !290 ; [debug line = 390:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %begin.index, i16 %begin.sample, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !291 ; [debug line = 391:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %end.index, i16 %end.sample, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !292 ; [debug line = 392:1]
  call void (...)* @_ssdm_op_SpecIFCore(i1 %stop_on_first, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !293 ; [debug line = 393:1]
  call void (...)* @_ssdm_op_SpecIFCore(i1 %accept, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !294 ; [debug line = 394:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33), !dbg !295 ; [debug line = 395:1]
  call void @llvm.dbg.value(metadata !{i16 %begin.index}, i64 0, metadata !296), !dbg !300 ; [debug line = 399:7] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %begin.index}, i64 0, metadata !296), !dbg !300 ; [debug line = 399:7] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %begin.index}, i64 0, metadata !296), !dbg !300 ; [debug line = 399:7] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %begin.sample}, i64 0, metadata !302), !dbg !300 ; [debug line = 399:7] [debug variable = i.sample]
  br label %1, !dbg !300                          ; [debug line = 399:7]
...
; <label>:1                                       ; preds = %._crit_edge3, %0
  ...
  call void @llvm.dbg.value(metadata !{i16 %i.sample}, i64 0, metadata !302), !dbg !305 ; [debug line = 399:55] [debug variable = i.sample]
  call void @llvm.dbg.value(metadata !{i16 %i.sample}, i64 0, metadata !302), !dbg !305 ; [debug line = 399:55] [debug variable = i.sample]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %end.index, i16 %end.sample, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33)
  %tmp.i = icmp eq i16 %i.sample, %end.sample, !dbg !306 ; [#uses=1 type=i1] [debug line = 263:2@399:19]
  %tmp..i = icmp eq i16 %i.index, %end.index, !dbg !306 ; [#uses=1 type=i1] [debug line = 263:2@399:19]
  %tmp...i = and i1 %tmp.i, %tmp..i, !dbg !306    ; [#uses=1 type=i1] [debug line = 263:2@399:19]
  br i1 %tmp...i, label %._crit_edge, label %2, !dbg !311 ; [debug line = 399:19]

; <label>:2                                       ; preds = %1
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str34), !dbg !312 ; [#uses=1 type=i32] [debug line = 400:3]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 65535, i32 2000, [1 x i8]* @.str212) nounwind, !dbg !314 ; [debug line = 401:1]
  ...
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !315), !dbg !316 ; [debug line = 402:20] [debug variable = offset]
  %tmp.2 = zext i32 %offset to i64, !dbg !317     ; [#uses=1 type=i64] [debug line = 403:13]
  call void @llvm.dbg.value(metadata !{i32* %nfa.initials.buckets}, i64 0, metadata !318), !dbg !323 ; [debug line = 277:38@403:13] [debug variable = nfa.initials.buckets]
  call void @llvm.dbg.value(metadata !{i32* %nfa.finals.buckets}, i64 0, metadata !324), !dbg !323 ; [debug line = 277:38@403:13] [debug variable = nfa.finals.buckets]
  call void @llvm.dbg.value(metadata !{i32* %nfa.forward.buckets}, i64 0, metadata !325), !dbg !323 ; [debug line = 277:38@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{[16065 x [2 x i32]]* %nfa.backward.buckets}, i64 0, metadata !326), !dbg !323 ; [debug line = 277:38@403:13] [debug variable = nfa.backward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa.symbols}, i64 0, metadata !327), !dbg !323 ; [debug line = 277:38@403:13] [debug variable = nfa.symbols]
  call void @llvm.dbg.value(metadata !{i16 %sample_length}, i64 0, metadata !328) nounwind, !dbg !329 ; [debug line = 279:11@403:13] [debug variable = length]
  %call.ret1 = call fastcc { i32, i32 } @nfa_get_initials(i32* %nfa.initials.buckets), !dbg !330 ; [#uses=2 type={ i32, i32 }] [debug line = 288:2@403:13]
  %"current.buckets[0]" = extractvalue { i32, i32 } %call.ret1, 0, !dbg !330 ; [#uses=1 type=i32] [debug line = 288:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"current.buckets[0]"}, i64 0, metadata !332), !dbg !330 ; [debug line = 288:2@403:13] [debug variable = current.buckets[0]]
  %"current.buckets[1]" = extractvalue { i32, i32 } %call.ret1, 1, !dbg !330 ; [#uses=1 type=i32] [debug line = 288:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"current.buckets[1]"}, i64 0, metadata !337), !dbg !330 ; [debug line = 288:2@403:13] [debug variable = current.buckets[1]]
  br label %3, !dbg !338                          ; [debug line = 291:7@403:13]
...
; <label>:3                                       ; preds = %11, %2
  ...
  %sum = add i64 %.01.rec.i, %tmp.2               ; [#uses=1 type=i64]
  %sample_buffer.addr = getelementptr i8* %sample_buffer, i64 %sum ; [#uses=1 type=i8*]
  %tmp.3 = icmp ult i16 %i.0.i, %sample_length, !dbg !338 ; [#uses=1 type=i1] [debug line = 291:7@403:13]
  br i1 %tmp.3, label %4, label %bitset_any.exit, !dbg !338 ; [debug line = 291:7@403:13]

; <label>:4                                       ; preds = %3
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !340 ; [#uses=1 type=i32] [debug line = 292:3@403:13]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1024, i32 512, [1 x i8]* @.str212) nounwind, !dbg !342 ; [debug line = 294:1@403:13]
  %.rec.i = add i64 %.01.rec.i, 1, !dbg !343      ; [#uses=1 type=i64] [debug line = 295:26@403:13]
  %sym = load i8* %sample_buffer.addr, align 1, !dbg !343 ; [#uses=2 type=i8] [debug line = 295:26@403:13]
  call void @llvm.dbg.value(metadata !{i8 %sym}, i64 0, metadata !344) nounwind, !dbg !343 ; [debug line = 295:26@403:13] [debug variable = sym]
  %tmp.2.i = icmp eq i32 %"next.buckets[0]", 0, !dbg !345 ; [#uses=1 type=i1] [debug line = 199:3@303:12@403:13]
  br i1 %tmp.2.i, label %6, label %5, !dbg !345   ; [debug line = 199:3@303:12@403:13]
...
; <label>:5                                       ; preds = %6, %4
  ...
  %agg.result.bucket_index.0.lcssa4.i.cast = zext i1 %agg.result.bucket_index.0.lcssa4.i to i8, !dbg !354 ; [#uses=1 type=i8] [debug line = 59:24@201:12@303:12@403:13]
  call void @llvm.dbg.value(metadata !{i32 %bus.assign}, i64 0, metadata !357) nounwind, !dbg !354 ; [debug line = 59:24@201:12@303:12@403:13] [debug variable = bus]
  %r.bit = call fastcc zeroext i5 @_bsf32_hw(i32 %bus.assign) nounwind, !dbg !358 ; [#uses=1 type=i5] [debug line = 61:9@201:12@303:12@403:13]
  %j.bit1.trunc.ext = zext i5 %r.bit to i8, !dbg !355 ; [#uses=1 type=i8] [debug line = 201:12@303:12@403:13]
  br label %bitset_first.exit, !dbg !359          ; [debug line = 202:4@303:12@403:13]

; <label>:6                                       ; preds = %4
  %tmp.2.1.i = icmp eq i32 %"next.buckets[1]", 0, !dbg !345 ; [#uses=1 type=i1] [debug line = 199:3@303:12@403:13]
  br i1 %tmp.2.1.i, label %bitset_first.exit, label %5, !dbg !345 ; [debug line = 199:3@303:12@403:13]
...
bitset_first.exit:                                ; preds = %nfa_get_sucessors.exit, %6, %5
  ...
  %j.bucket_index1.cast = trunc i8 %j.bucket_index1 to i6, !dbg !360 ; [#uses=1 type=i6] [debug line = 303:56@403:13]
  %j.bit1.cast = trunc i8 %j.bit1 to i6, !dbg !360 ; [#uses=1 type=i6] [debug line = 303:56@403:13]
  call void @llvm.dbg.value(metadata !{i1 %j.end}, i64 0, metadata !361), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.end]
  call void @llvm.dbg.value(metadata !{i1 %j.end}, i64 0, metadata !361), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.end]
  call void @llvm.dbg.value(metadata !{i1 %j.end}, i64 0, metadata !361), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.end]
  br i1 %j.end, label %10, label %bitset_element.exit, !dbg !374 ; [debug line = 303:37@403:13]

bitset_element.exit:                              ; preds = %bitset_first.exit
  %tmp.7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str13), !dbg !375 ; [#uses=1 type=i32] [debug line = 304:4@403:13]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 64, i32 5, [1 x i8]* @.str212) nounwind, !dbg !377 ; [debug line = 306:1@403:13]
  %tmp.i1 = shl i6 %j.bucket_index1.cast, 5, !dbg !378 ; [#uses=1 type=i6] [debug line = 187:2@307:18@403:13]
  %state = add i6 %tmp.i1, %j.bit1.cast, !dbg !378 ; [#uses=2 type=i6] [debug line = 187:2@307:18@403:13]
  call void @llvm.dbg.value(metadata !{i6 %state}, i64 0, metadata !386) nounwind, !dbg !385 ; [debug line = 307:18@403:13] [debug variable = state]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %nfa.symbols, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33)
  call void @llvm.dbg.value(metadata !{i32* %nfa.forward.buckets}, i64 0, metadata !389), !dbg !396 ; [debug line = 97:37@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa.symbols}, i64 0, metadata !397), !dbg !396 ; [debug line = 97:37@309:2@403:13] [debug variable = nfa.symbols]
  call void @llvm.dbg.value(metadata !{i6 %state}, i64 0, metadata !398), !dbg !399 ; [debug line = 97:50@309:2@403:13] [debug variable = state]
  call void @llvm.dbg.value(metadata !{i8 %sym}, i64 0, metadata !400), !dbg !401 ; [debug line = 97:66@309:2@403:13] [debug variable = sym]
  call void @llvm.dbg.value(metadata !{i32* %nfa.forward.buckets}, i64 0, metadata !402), !dbg !410 ; [debug line = 28:37@100:22@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa.symbols}, i64 0, metadata !411), !dbg !410 ; [debug line = 28:37@100:22@309:2@403:13] [debug variable = nfa.symbols]
  %tmp.i2 = icmp eq i6 %state, -1, !dbg !409      ; [#uses=1 type=i1] [debug line = 100:22@309:2@403:13]
  br i1 %tmp.i2, label %7, label %._crit_edge.i, !dbg !409 ; [debug line = 100:22@309:2@403:13]
...
._crit_edge.i:                                    ; preds = %bitset_element.exit
  call void @llvm.dbg.value(metadata !{i32* %nfa.forward.buckets}, i64 0, metadata !412), !dbg !419 ; [debug line = 90:39@101:20@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa.symbols}, i64 0, metadata !420), !dbg !419 ; [debug line = 90:39@101:20@309:2@403:13] [debug variable = nfa.symbols]
  %nfa.symbols.load = load i8* %nfa.symbols, align 1, !dbg !421 ; [#uses=2 type=i8] [debug line = 93:2@101:20@309:2@403:13]
  %tmp..i2 = icmp ugt i8 %nfa.symbols.load, %sym, !dbg !418 ; [#uses=1 type=i1] [debug line = 101:20@309:2@403:13]
  br i1 %tmp..i2, label %nfa_get_sucessors.exit, label %8, !dbg !418 ; [debug line = 101:20@309:2@403:13]
...
nfa_get_sucessors.exit:                           ; preds = %._crit_edge.i
  %tmp.7.i.cast = zext i6 %state to i14, !dbg !423 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  call void @llvm.dbg.value(metadata !{i32* %nfa.forward.buckets}, i64 0, metadata !424), !dbg !427 ; [debug line = 90:39@103:27@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa.symbols}, i64 0, metadata !428), !dbg !427 ; [debug line = 90:39@103:27@309:2@403:13] [debug variable = nfa.symbols]
  %tmp.8.i.cast = zext i8 %nfa.symbols.load to i14, !dbg !423 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  %tmp.9.i = mul i14 %tmp.8.i.cast, %tmp.7.i.cast, !dbg !423 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  %tmp.10.i.cast = zext i8 %sym to i14, !dbg !423 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  %tmp.11.i = add i14 %tmp.9.i, %tmp.10.i.cast, !dbg !423 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  %offset.1.cast = zext i14 %tmp.11.i to i15, !dbg !423 ; [#uses=1 type=i15] [debug line = 103:27@309:2@403:13]
  %tmp.12.i = shl nuw i15 %offset.1.cast, 1       ; [#uses=2 type=i15]
  %tmp.12.i.cast = zext i15 %tmp.12.i to i64      ; [#uses=1 type=i64]
  %nfa.forward.buckets.addr = getelementptr i32* %nfa.forward.buckets, i64 %tmp.12.i.cast ; [#uses=1 type=i32*]
  %"tmp.buckets[0].2" = load i32* %nfa.forward.buckets.addr, align 4, !dbg !429 ; [#uses=1 type=i32] [debug line = 104:2@309:2@403:13]
  %tmp.13.i = or i15 %tmp.12.i, 1                 ; [#uses=1 type=i15]
  %tmp.13.i.cast = zext i15 %tmp.13.i to i64      ; [#uses=1 type=i64]
  %nfa.forward.buckets.addr.1 = getelementptr i32* %nfa.forward.buckets, i64 %tmp.13.i.cast ; [#uses=1 type=i32*]
  %"tmp.buckets[1].2" = load i32* %nfa.forward.buckets.addr.1, align 4, !dbg !429 ; [#uses=1 type=i32] [debug line = 104:2@309:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[0].2"}, i64 0, metadata !430), !dbg !395 ; [debug line = 309:2@403:13] [debug variable = tmp.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1].2"}, i64 0, metadata !432), !dbg !395 ; [debug line = 309:2@403:13] [debug variable = tmp.buckets[1]]
  %"next.buckets[0].1" = or i32 %"tmp.buckets[0].2", %"tmp.buckets[0].3", !dbg !433 ; [#uses=1 type=i32] [debug line = 156:3@311:2@403:13]
  %"next.buckets[1].1" = or i32 %"tmp.buckets[1].2", %"tmp.buckets[1].3", !dbg !433 ; [#uses=1 type=i32] [debug line = 156:3@311:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"next.buckets[0].1"}, i64 0, metadata !442), !dbg !441 ; [debug line = 311:2@403:13] [debug variable = next.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"next.buckets[1].1"}, i64 0, metadata !444), !dbg !441 ; [debug line = 311:2@403:13] [debug variable = next.buckets[1]]
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str13, i32 %tmp.7), !dbg !445 ; [#uses=0 type=i32] [debug line = 313:3@403:13]
  %call.ret6 = call fastcc { i8, i8, i32, i1 } @bitset_next(i32 %"next.buckets[1]", i8 %j.bit1, i8 %j.bucket_index1, i32 %j.bucket1), !dbg !360 ; [#uses=4 type={ i8, i8, i32, i1 }] [debug line = 303:56@403:13]
  %j.bit = extractvalue { i8, i8, i32, i1 } %call.ret6, 0, !dbg !360 ; [#uses=1 type=i8] [debug line = 303:56@403:13]
  %j.bucket_index = extractvalue { i8, i8, i32, i1 } %call.ret6, 1, !dbg !360 ; [#uses=1 type=i8] [debug line = 303:56@403:13]
  %j.bucket = extractvalue { i8, i8, i32, i1 } %call.ret6, 2, !dbg !360 ; [#uses=1 type=i32] [debug line = 303:56@403:13]
  %. = extractvalue { i8, i8, i32, i1 } %call.ret6, 3, !dbg !360 ; [#uses=1 type=i1] [debug line = 303:56@403:13]
  call void @llvm.dbg.value(metadata !{i8 %j.bit}, i64 0, metadata !446), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bit]
  call void @llvm.dbg.value(metadata !{i8 %j.bit}, i64 0, metadata !446), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bit]
  call void @llvm.dbg.value(metadata !{i8 %j.bit}, i64 0, metadata !446), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bit]
  call void @llvm.dbg.value(metadata !{i8 %j.bucket_index}, i64 0, metadata !449), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bucket_index]
  call void @llvm.dbg.value(metadata !{i8 %j.bucket_index}, i64 0, metadata !449), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bucket_index]
  call void @llvm.dbg.value(metadata !{i8 %j.bucket_index}, i64 0, metadata !449), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bucket_index]
  call void @llvm.dbg.value(metadata !{i32 %j.bucket}, i64 0, metadata !452), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bucket]
  call void @llvm.dbg.value(metadata !{i32 %j.bucket}, i64 0, metadata !452), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bucket]
  call void @llvm.dbg.value(metadata !{i32 %j.bucket}, i64 0, metadata !452), !dbg !360 ; [debug line = 303:56@403:13] [debug variable = j.bucket]
  br label %bitset_first.exit, !dbg !360          ; [debug line = 303:56@403:13]

; <label>:10                                      ; preds = %bitset_first.exit
  br i1 %any.0.i, label %11, label %nfa_accept_sample.exit, !dbg !455 ; [debug line = 315:3@403:13]

; <label>:11                                      ; preds = %10
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[0].3"}, i64 0, metadata !430), !dbg !456 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[0].3"}, i64 0, metadata !430), !dbg !456 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1].3"}, i64 0, metadata !432), !dbg !456 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1].3"}, i64 0, metadata !432), !dbg !456 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %"next.buckets[0]"}, i64 0, metadata !442), !dbg !457 ; [debug line = 318:3@403:13] [debug variable = next.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"next.buckets[0]"}, i64 0, metadata !442), !dbg !457 ; [debug line = 318:3@403:13] [debug variable = next.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"next.buckets[1]"}, i64 0, metadata !444), !dbg !457 ; [debug line = 318:3@403:13] [debug variable = next.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %"next.buckets[1]"}, i64 0, metadata !444), !dbg !457 ; [debug line = 318:3@403:13] [debug variable = next.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[0].3"}, i64 0, metadata !332), !dbg !458 ; [debug line = 319:3@403:13] [debug variable = current.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[0].3"}, i64 0, metadata !332), !dbg !458 ; [debug line = 319:3@403:13] [debug variable = current.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1].3"}, i64 0, metadata !337), !dbg !458 ; [debug line = 319:3@403:13] [debug variable = current.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1].3"}, i64 0, metadata !337), !dbg !458 ; [debug line = 319:3@403:13] [debug variable = current.buckets[1]]
  %12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.4), !dbg !459 ; [#uses=0 type=i32] [debug line = 320:2@403:13]
  %i = add i16 %i.0.i, 1, !dbg !460               ; [#uses=1 type=i16] [debug line = 291:26@403:13]
  call void @llvm.dbg.value(metadata !{i16 %i}, i64 0, metadata !461) nounwind, !dbg !460 ; [debug line = 291:26@403:13] [debug variable = i]
  br label %3, !dbg !460                          ; [debug line = 291:26@403:13]
...
bitset_any.exit:                                  ; preds = %3
  ...
  %call.ret2 = call fastcc { i32, i32 } @nfa_get_finals(i32* %nfa.finals.buckets), !dbg !462 ; [#uses=2 type={ i32, i32 }] [debug line = 322:2@403:13]
  %"tmp.buckets[0]" = extractvalue { i32, i32 } %call.ret2, 0, !dbg !462 ; [#uses=1 type=i32] [debug line = 322:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[0]"}, i64 0, metadata !430), !dbg !462 ; [debug line = 322:2@403:13] [debug variable = tmp.buckets[0]]
  %"tmp.buckets[1]" = extractvalue { i32, i32 } %call.ret2, 1, !dbg !462 ; [#uses=1 type=i32] [debug line = 322:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"tmp.buckets[1]"}, i64 0, metadata !432), !dbg !462 ; [debug line = 322:2@403:13] [debug variable = tmp.buckets[1]]
  %"current.buckets[0].1" = and i32 %"next.buckets[0].lcssa", %"tmp.buckets[0]", !dbg !463 ; [#uses=1 type=i32] [debug line = 166:3@324:2@403:13]
  %"current.buckets[1].1" = and i32 %"next.buckets[1].lcssa", %"tmp.buckets[1]", !dbg !463 ; [#uses=1 type=i32] [debug line = 166:3@324:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %"current.buckets[0].1"}, i64 0, metadata !332), !dbg !468 ; [debug line = 324:2@403:13] [debug variable = current.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %"current.buckets[1].1"}, i64 0, metadata !337), !dbg !468 ; [debug line = 324:2@403:13] [debug variable = current.buckets[1]]
  %tmp.1 = or i32 %"current.buckets[1].1", %"current.buckets[0].1", !dbg !469 ; [#uses=1 type=i32] [debug line = 176:3@327:9@403:13]
  %tmp.5 = icmp ne i32 %tmp.1, 0, !dbg !469       ; [#uses=1 type=i1] [debug line = 176:3@327:9@403:13]
  br label %nfa_accept_sample.exit, !dbg !476     ; [debug line = 327:9@403:13]

nfa_accept_sample.exit:                           ; preds = %bitset_any.exit, %10
  %r = phi i1 [ %tmp.5, %bitset_any.exit ], [ false, %10 ] ; [#uses=1 type=i1]
  call void @llvm.dbg.value(metadata !{i1 %r}, i64 0, metadata !477), !dbg !317 ; [debug line = 403:13] [debug variable = r]
  %or.cond = xor i1 %r, %accept, !dbg !478        ; [#uses=1 type=i1] [debug line = 404:3]
  br i1 %or.cond, label %._crit_edge3, label %13, !dbg !478 ; [debug line = 404:3]

; <label>:13                                      ; preds = %nfa_accept_sample.exit
  br i1 %stop_on_first, label %._crit_edge, label %14, !dbg !479 ; [debug line = 406:4]

; <label>:14                                      ; preds = %13
  %c.2 = add nsw i32 %c, 1, !dbg !481             ; [#uses=1 type=i32] [debug line = 407:4]
  call void @llvm.dbg.value(metadata !{i32 %c.2}, i64 0, metadata !482), !dbg !481 ; [debug line = 407:4] [debug variable = c]
  br label %._crit_edge3, !dbg !483               ; [debug line = 408:3]

._crit_edge3:                                     ; preds = %14, %nfa_accept_sample.exit
  %c.1 = phi i32 [ %c.2, %14 ], [ %c, %nfa_accept_sample.exit ] ; [#uses=1 type=i32]
  %15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str34, i32 %tmp), !dbg !484 ; [#uses=0 type=i32] [debug line = 409:2]
  %call.ret7 = call fastcc { i16, i16 } @sample_iterator_next(i56* %indices, i16 %i.index, i16 %i.sample) ; [#uses=2 type={ i16, i16 }]
  %i.index.1 = extractvalue { i16, i16 } %call.ret7, 0, !dbg !305 ; [#uses=1 type=i16] [debug line = 399:55]
  %i.sample.1 = extractvalue { i16, i16 } %call.ret7, 1, !dbg !305 ; [#uses=1 type=i16] [debug line = 399:55]
  call void @llvm.dbg.value(metadata !{i16 %i.index.1}, i64 0, metadata !296), !dbg !305 ; [debug line = 399:55] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %i.index.1}, i64 0, metadata !296), !dbg !305 ; [debug line = 399:55] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %i.index.1}, i64 0, metadata !296), !dbg !305 ; [debug line = 399:55] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %i.sample.1}, i64 0, metadata !302), !dbg !305 ; [debug line = 399:55] [debug variable = i.sample]
  br label %1, !dbg !305                          ; [debug line = 399:55]

._crit_edge:                                      ; preds = %13, %1
  %.0 = phi i32 [ %c, %1 ], [ 1, %13 ]            ; [#uses=1 type=i32]
  ret i32 %.0, !dbg !485                          ; [debug line = 411:1]
}

; [#uses=1]
define internal fastcc { i32, i32 } @nfa_get_initials(i32* %nfa.initials.buckets) readonly {
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.initials.buckets, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.initials.buckets, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
...
define internal fastcc { i32, i32 } @nfa_get_finals(i32* %nfa.finals.buckets) readonly {
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa.finals.buckets, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa.finals.buckets, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
...
define internal fastcc i32 @sample_iterator_get_offset(i16 %i.index, i16 %i.sample, i56* %indices, i32 %sample_buffer_size, i16 zeroext %sample_length) {
  ...
  call void (...)* @_ssdm_op_SpecBus(i56* %indices, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecIFCore(i56* %indices, [1 x i8]* @.str212, [7 x i8]* @.str31, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  call void (...)* @_ssdm_op_SpecIFCore(i16 %sample_length, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %sample_buffer_size, [1 x i8]* @.str212, [7 x i8]* @.str32, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212, [17 x i8]* @.str33)
  call void (...)* @_ssdm_op_SpecBus(i56* %indices, [7 x i8]* @.str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @.str212, [1 x i8]* @.str212, [1 x i8]* @.str212)
  ...
  %tmp.1.cast = zext i16 %i.sample to i24, !dbg !515 ; [#uses=1 type=i24] [debug line = 271:79]
  %tmp.2 = mul i24 %tmp.1.cast, %tmp..cast, !dbg !515 ; [#uses=1 type=i24] [debug line = 271:79]
  %tmp.2.cast = zext i24 %tmp.2 to i32, !dbg !515 ; [#uses=1 type=i32] [debug line = 271:79]
  %offset = add i32 %tmp.2.cast, %indices.begin.load.new4, !dbg !515 ; [#uses=2 type=i32] [debug line = 271:79]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !517), !dbg !515 ; [debug line = 271:79] [debug variable = offset]
  %tmp.3 = zext i16 %sample_length to i32, !dbg !518 ; [#uses=1 type=i32] [debug line = 272:2]
  %tmp.4 = sub i32 %sample_buffer_size, %tmp.3, !dbg !518 ; [#uses=1 type=i32] [debug line = 272:2]
  %tmp.5 = icmp ugt i32 %offset, %tmp.4, !dbg !518 ; [#uses=1 type=i1] [debug line = 272:2]
  br i1 %tmp.5, label %1, label %._crit_edge, !dbg !518 ; [debug line = 272:2]
...
define internal fastcc { i16, i16 } @sample_iterator_next(i56* %indices, i16 %i.index, i16 %i.sample) readonly {
  ...
  %tmp. = zext i16 %i.index to i64, !dbg !529     ; [#uses=1 type=i64] [debug line = 250:2]
  %indices.addr = getelementptr i56* %indices, i64 %tmp. ; [#uses=1 type=i56*]
  ...
  %tmp.6.cast = zext i16 %indices.samples.load.new5 to i17, !dbg !529 ; [#uses=1 type=i17] [debug line = 250:2]
  %tmp.7 = add i17 %tmp.6.cast, -1, !dbg !529     ; [#uses=1 type=i17] [debug line = 250:2]
  %tmp.7.cast = sext i17 %tmp.7 to i18, !dbg !529 ; [#uses=1 type=i18] [debug line = 250:2]
  %tmp.8 = icmp slt i18 %tmp.cast, %tmp.7.cast, !dbg !529 ; [#uses=2 type=i1] [debug line = 250:2]
  %tmp.9 = add i16 %i.index, 1, !dbg !531         ; [#uses=1 type=i16] [debug line = 254:3]
  %tmp.1 = add i16 %i.sample, 1, !dbg !533        ; [#uses=1 type=i16] [debug line = 252:3]
  %agg.result.sample.write.assign = select i1 %tmp.8, i16 %tmp.1, i16 0, !dbg !529 ; [#uses=1 type=i16] [debug line = 250:2]
  %agg.result.index.write.assign = select i1 %tmp.8, i16 %i.index, i16 %tmp.9, !dbg !529 ; [#uses=1 type=i16] [debug line = 250:2]
...
._crit_edge.1:                                    ; preds = %._crit_edge.0
  ...
  %tmp.4.1 = icmp sgt i2 %bus.cast29, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.1, label %._crit_edge.2, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.2:                                    ; preds = %._crit_edge.1
  %bus.cast28 = trunc i32 %bus to i3, !dbg !547   ; [#uses=1 type=i3] [debug line = 55:2]
  %tmp.4.2 = icmp sgt i3 %bus.cast28, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.2, label %._crit_edge.3, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.3:                                    ; preds = %._crit_edge.2
  %bus.cast27 = trunc i32 %bus to i4, !dbg !547   ; [#uses=1 type=i4] [debug line = 55:2]
  %tmp.4.3 = icmp sgt i4 %bus.cast27, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.3, label %._crit_edge.4, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.4:                                    ; preds = %._crit_edge.3
  %bus.cast26 = trunc i32 %bus to i5, !dbg !547   ; [#uses=1 type=i5] [debug line = 55:2]
  %tmp.4.4 = icmp sgt i5 %bus.cast26, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.4, label %._crit_edge.5, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.5:                                    ; preds = %._crit_edge.4
  %bus.cast25 = trunc i32 %bus to i6, !dbg !547   ; [#uses=1 type=i6] [debug line = 55:2]
  %tmp.4.5 = icmp sgt i6 %bus.cast25, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.5, label %._crit_edge.6, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.6:                                    ; preds = %._crit_edge.5
  %bus.cast24 = trunc i32 %bus to i7, !dbg !547   ; [#uses=1 type=i7] [debug line = 55:2]
  %tmp.4.6 = icmp sgt i7 %bus.cast24, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.6, label %._crit_edge.7, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.7:                                    ; preds = %._crit_edge.6
  %bus.cast23 = trunc i32 %bus to i8, !dbg !547   ; [#uses=1 type=i8] [debug line = 55:2]
  %tmp.4.7 = icmp sgt i8 %bus.cast23, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.7, label %._crit_edge.8, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.8:                                    ; preds = %._crit_edge.7
  %bus.cast22 = trunc i32 %bus to i9, !dbg !547   ; [#uses=1 type=i9] [debug line = 55:2]
  %tmp.4.8 = icmp sgt i9 %bus.cast22, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.8, label %._crit_edge.9, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.9:                                    ; preds = %._crit_edge.8
  %bus.cast21 = trunc i32 %bus to i10, !dbg !547  ; [#uses=1 type=i10] [debug line = 55:2]
  %tmp.4.9 = icmp sgt i10 %bus.cast21, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.9, label %._crit_edge.10, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.10:                                   ; preds = %._crit_edge.9
  %bus.cast20 = trunc i32 %bus to i11, !dbg !547  ; [#uses=1 type=i11] [debug line = 55:2]
  %tmp.4. = icmp sgt i11 %bus.cast20, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4., label %._crit_edge.11, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.11:                                   ; preds = %._crit_edge.10
  %bus.cast19 = trunc i32 %bus to i12, !dbg !547  ; [#uses=1 type=i12] [debug line = 55:2]
  %tmp.4.10 = icmp sgt i12 %bus.cast19, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.10, label %._crit_edge.12, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.12:                                   ; preds = %._crit_edge.11
  %bus.cast18 = trunc i32 %bus to i13, !dbg !547  ; [#uses=1 type=i13] [debug line = 55:2]
  %tmp.4.11 = icmp sgt i13 %bus.cast18, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.11, label %._crit_edge.13, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.13:                                   ; preds = %._crit_edge.12
  %bus.cast17 = trunc i32 %bus to i14, !dbg !547  ; [#uses=1 type=i14] [debug line = 55:2]
  %tmp.4.12 = icmp sgt i14 %bus.cast17, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.12, label %._crit_edge.14, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.14:                                   ; preds = %._crit_edge.13
  %bus.cast16 = trunc i32 %bus to i15, !dbg !547  ; [#uses=1 type=i15] [debug line = 55:2]
  %tmp.4.13 = icmp sgt i15 %bus.cast16, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.13, label %._crit_edge.15, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.15:                                   ; preds = %._crit_edge.14
  %bus.cast15 = trunc i32 %bus to i16, !dbg !547  ; [#uses=1 type=i16] [debug line = 55:2]
  %tmp.4.14 = icmp sgt i16 %bus.cast15, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.14, label %._crit_edge.16, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.16:                                   ; preds = %._crit_edge.15
  %bus.cast14 = trunc i32 %bus to i17, !dbg !547  ; [#uses=1 type=i17] [debug line = 55:2]
  %tmp.4.15 = icmp sgt i17 %bus.cast14, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.15, label %._crit_edge.17, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.17:                                   ; preds = %._crit_edge.16
  %bus.cast13 = trunc i32 %bus to i18, !dbg !547  ; [#uses=1 type=i18] [debug line = 55:2]
  %tmp.4.16 = icmp sgt i18 %bus.cast13, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.16, label %._crit_edge.18, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.18:                                   ; preds = %._crit_edge.17
  %bus.cast12 = trunc i32 %bus to i19, !dbg !547  ; [#uses=1 type=i19] [debug line = 55:2]
  %tmp.4.17 = icmp sgt i19 %bus.cast12, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.17, label %._crit_edge.19, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.19:                                   ; preds = %._crit_edge.18
  %bus.cast11 = trunc i32 %bus to i20, !dbg !547  ; [#uses=1 type=i20] [debug line = 55:2]
  %tmp.4.18 = icmp sgt i20 %bus.cast11, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.18, label %._crit_edge.20, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.20:                                   ; preds = %._crit_edge.19
  %bus.cast10 = trunc i32 %bus to i21, !dbg !547  ; [#uses=1 type=i21] [debug line = 55:2]
  %tmp.4.19 = icmp sgt i21 %bus.cast10, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.19, label %._crit_edge.21, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.21:                                   ; preds = %._crit_edge.20
  %bus.cast9 = trunc i32 %bus to i22, !dbg !547   ; [#uses=1 type=i22] [debug line = 55:2]
  %tmp.4.20 = icmp sgt i22 %bus.cast9, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.20, label %._crit_edge.22, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.22:                                   ; preds = %._crit_edge.21
  %bus.cast8 = trunc i32 %bus to i23, !dbg !547   ; [#uses=1 type=i23] [debug line = 55:2]
  %tmp.4.21 = icmp sgt i23 %bus.cast8, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.21, label %._crit_edge.23, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.23:                                   ; preds = %._crit_edge.22
  %bus.cast7 = trunc i32 %bus to i24, !dbg !547   ; [#uses=1 type=i24] [debug line = 55:2]
  %tmp.4.22 = icmp sgt i24 %bus.cast7, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.22, label %._crit_edge.24, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.24:                                   ; preds = %._crit_edge.23
  %bus.cast6 = trunc i32 %bus to i25, !dbg !547   ; [#uses=1 type=i25] [debug line = 55:2]
  %tmp.4.23 = icmp sgt i25 %bus.cast6, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.23, label %._crit_edge.25, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.25:                                   ; preds = %._crit_edge.24
  %bus.cast5 = trunc i32 %bus to i26, !dbg !547   ; [#uses=1 type=i26] [debug line = 55:2]
  %tmp.4.24 = icmp sgt i26 %bus.cast5, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.24, label %._crit_edge.26, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.26:                                   ; preds = %._crit_edge.25
  %bus.cast4 = trunc i32 %bus to i27, !dbg !547   ; [#uses=1 type=i27] [debug line = 55:2]
  %tmp.4.25 = icmp sgt i27 %bus.cast4, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.25, label %._crit_edge.27, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.27:                                   ; preds = %._crit_edge.26
  %bus.cast3 = trunc i32 %bus to i28, !dbg !547   ; [#uses=1 type=i28] [debug line = 55:2]
  %tmp.4.26 = icmp sgt i28 %bus.cast3, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.26, label %._crit_edge.28, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.28:                                   ; preds = %._crit_edge.27
  %bus.cast2 = trunc i32 %bus to i29, !dbg !547   ; [#uses=1 type=i29] [debug line = 55:2]
  %tmp.4.27 = icmp sgt i29 %bus.cast2, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.27, label %._crit_edge.29, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.29:                                   ; preds = %._crit_edge.28
  %bus.cast1 = trunc i32 %bus to i30, !dbg !547   ; [#uses=1 type=i30] [debug line = 55:2]
  %tmp.4.28 = icmp sgt i30 %bus.cast1, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.28, label %._crit_edge.30, label %.loopexit, !dbg !547 ; [debug line = 55:2]

._crit_edge.30:                                   ; preds = %._crit_edge.29
  %bus.cast = trunc i32 %bus to i31, !dbg !547    ; [#uses=1 type=i31] [debug line = 55:2]
  %tmp.4.29 = icmp sgt i31 %bus.cast, -1, !dbg !547 ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %tmp.4.29, label %._crit_edge.31, label %.loopexit, !dbg !547 ; [debug line = 55:2]
...
!283 = metadata !{i32 381, i32 1, metadata !270, null}
!284 = metadata !{i32 382, i32 1, metadata !270, null}
!285 = metadata !{i32 383, i32 1, metadata !270, null}
!286 = metadata !{i32 385, i32 1, metadata !270, null}
!287 = metadata !{i32 386, i32 1, metadata !270, null}
!288 = metadata !{i32 387, i32 1, metadata !270, null}
!289 = metadata !{i32 388, i32 1, metadata !270, null}
!290 = metadata !{i32 390, i32 1, metadata !270, null}
!291 = metadata !{i32 391, i32 1, metadata !270, null}
!292 = metadata !{i32 392, i32 1, metadata !270, null}
!293 = metadata !{i32 393, i32 1, metadata !270, null}
!294 = metadata !{i32 394, i32 1, metadata !270, null}
!295 = metadata !{i32 395, i32 1, metadata !270, null}
!296 = metadata !{i32 790529, metadata !297, metadata !"i.index", null, i32 398, metadata !298, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!297 = metadata !{i32 786688, metadata !270, metadata !"i", metadata !175, i32 398, metadata !216, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!300 = metadata !{i32 399, i32 7, metadata !301, null}
!301 = metadata !{i32 786443, metadata !270, i32 399, i32 2, metadata !175, i32 45} ; [ DW_TAG_lexical_block ]
!302 = metadata !{i32 790529, metadata !297, metadata !"i.sample", null, i32 398, metadata !303, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!305 = metadata !{i32 399, i32 55, metadata !301, null}
...
!311 = metadata !{i32 399, i32 19, metadata !301, null}
!312 = metadata !{i32 400, i32 3, metadata !313, null}
!313 = metadata !{i32 786443, metadata !301, i32 400, i32 2, metadata !175, i32 46} ; [ DW_TAG_lexical_block ]
!314 = metadata !{i32 401, i32 1, metadata !313, null}
!315 = metadata !{i32 786688, metadata !313, metadata !"offset", metadata !175, i32 402, metadata !192, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!316 = metadata !{i32 402, i32 20, metadata !313, null}
!317 = metadata !{i32 403, i32 13, metadata !313, null}
...
!477 = metadata !{i32 786688, metadata !313, metadata !"r", metadata !175, i32 403, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!478 = metadata !{i32 404, i32 3, metadata !313, null}
!479 = metadata !{i32 406, i32 4, metadata !480, null}
!480 = metadata !{i32 786443, metadata !313, i32 405, i32 3, metadata !175, i32 47} ; [ DW_TAG_lexical_block ]
!481 = metadata !{i32 407, i32 4, metadata !480, null}
!482 = metadata !{i32 786688, metadata !270, metadata !"c", metadata !175, i32 397, metadata !178, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!483 = metadata !{i32 408, i32 3, metadata !480, null}
!484 = metadata !{i32 409, i32 2, metadata !313, null}
!485 = metadata !{i32 411, i32 1, metadata !270, null}
