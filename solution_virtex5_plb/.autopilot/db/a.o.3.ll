...
@p_str1 = private unnamed_addr constant [28 x i8] c"oil_plainc_hls/src/bitset.c\00", align 1 ; [#uses=0 type=[28 x i8]*]
@p_str9 = private unnamed_addr constant [9 x i8] c"bus != 0\00", align 1 ; [#uses=0 type=[9 x i8]*]
@p_str111 = private unnamed_addr constant [25 x i8] c"oil_plainc_hls/src/nfa.c\00", align 1 ; [#uses=0 type=[25 x i8]*]
@p_str212 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=179 type=[1 x i8]*]
@p_str313 = private unnamed_addr constant [28 x i8] c"state < nfa_get_states(nfa)\00", align 1 ; [#uses=0 type=[28 x i8]*]
@p_str414 = private unnamed_addr constant [27 x i8] c"sym < nfa_get_symbols(nfa)\00", align 1 ; [#uses=0 type=[27 x i8]*]
@p_str11 = private unnamed_addr constant [45 x i8] c"offset <= sample_buffer_size - sample_length\00", align 1 ; [#uses=0 type=[45 x i8]*]
@p_str12 = private unnamed_addr constant [12 x i8] c"hls_label_0\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
@p_str31 = private unnamed_addr constant [7 x i8] c"PLB46M\00", align 1 ; [#uses=12 type=[7 x i8]*]
...
@p_str34 = private unnamed_addr constant [12 x i8] c"hls_label_2\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
._crit_edge:
  ...
  %tmp_3 = add i32 %r_bucket_read, -1, !dbg !43   ; [#uses=1 type=i32] [debug line = 217:2]
  %bus_assign = and i32 %tmp_3, %r_bucket_read, !dbg !43 ; [#uses=3 type=i32] [debug line = 217:2]
  %tmp_5 = icmp eq i32 %bus_assign, 0, !dbg !44   ; [#uses=1 type=i1] [debug line = 218:2]
  br i1 %tmp_5, label %.preheader, label %0, !dbg !44 ; [debug line = 218:2]
...
.preheader:                                       ; preds = %._crit_edge
  %tmp_9_1 = icmp eq i2 %tmp, 0, !dbg !54         ; [#uses=1 type=i1] [debug line = 226:3]
  br i1 %tmp_9_1, label %2, label %.loopexit, !dbg !54 ; [debug line = 226:3]

; <label>:2                                       ; preds = %.preheader
  %tmp_11_1 = icmp eq i32 %p_read_1, 0, !dbg !55  ; [#uses=1 type=i1] [debug line = 229:4]
  br i1 %tmp_11_1, label %.loopexit, label %1, !dbg !55 ; [debug line = 229:4]
...
define i32 @nfa_accept_samples_generic_hw(i32* %nfa_initials_buckets, i32* %nfa_finals_buckets, i32* %nfa_forward_buckets, [32130 x i32]* %nfa_backward_buckets, i8* %nfa_symbols, i8* %sample_buffer, i32 %sample_buffer_length, i16 zeroext %sample_length, i56* %indices, i16 zeroext %i_size, i16 %begin_index, i16 %begin_sample, i16 %end_index, i16 %end_sample, i1 zeroext %stop_on_first, i1 zeroext %accept) {
  ...
  call void @llvm.dbg.value(metadata !{i16 %sample_length_read}, i64 0, metadata !216) nounwind, !dbg !224 ; [debug line = 279:11@403:13] [debug variable = length]
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str212) nounwind, !dbg !269 ; [debug line = 358:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa_initials_buckets, [7 x i8]* @p_str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !270 ; [debug line = 361:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa_finals_buckets, [7 x i8]* @p_str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !271 ; [debug line = 362:1]
  call void (...)* @_ssdm_op_SpecBus(i32* %nfa_forward_buckets, [7 x i8]* @p_str28, i32 0, i32 0, i32 0, i32 10, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !272 ; [debug line = 363:1]
  call void (...)* @_ssdm_op_SpecWire(i8* %nfa_symbols, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !273 ; [debug line = 364:1]
  ...
  call void (...)* @_ssdm_op_SpecWire(i32 %sample_buffer_length, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !274 ; [debug line = 366:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %sample_length, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !275 ; [debug line = 367:1]
  ...
  call void (...)* @_ssdm_op_SpecWire(i16 %i_size, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !276 ; [debug line = 369:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %begin_index, i16 %begin_sample, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !277 ; [debug line = 370:1]
  call void (...)* @_ssdm_op_SpecWire(i16 %end_index, i16 %end_sample, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !278 ; [debug line = 371:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %stop_on_first, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !279 ; [debug line = 372:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %accept, [8 x i8]* @p_str29, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !280 ; [debug line = 373:1]
  call void (...)* @_ssdm_op_SpecWire(i32 0, [11 x i8]* @p_str30, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212) nounwind, !dbg !281 ; [debug line = 374:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa_initials_buckets, [1 x i8]* @p_str212, [7 x i8]* @p_str31, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !282 ; [debug line = 381:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa_finals_buckets, [1 x i8]* @p_str212, [7 x i8]* @p_str31, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !283 ; [debug line = 382:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %nfa_forward_buckets, [1 x i8]* @p_str212, [7 x i8]* @p_str31, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !284 ; [debug line = 383:1]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %nfa_symbols, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !285 ; [debug line = 385:1]
  call void (...)* @_ssdm_op_SpecIFCore(i8* %sample_buffer, [1 x i8]* @p_str212, [7 x i8]* @p_str31, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212), !dbg !286 ; [debug line = 386:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 %sample_buffer_length, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !287 ; [debug line = 387:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %sample_length, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !288 ; [debug line = 388:1]
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i16 %i_size, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !289 ; [debug line = 390:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %begin_index, i16 %begin_sample, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !290 ; [debug line = 391:1]
  call void (...)* @_ssdm_op_SpecIFCore(i16 %end_index, i16 %end_sample, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !291 ; [debug line = 392:1]
  call void (...)* @_ssdm_op_SpecIFCore(i1 %stop_on_first, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !292 ; [debug line = 393:1]
  call void (...)* @_ssdm_op_SpecIFCore(i1 %accept, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !293 ; [debug line = 394:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str212, [7 x i8]* @p_str32, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [1 x i8]* @p_str212, [17 x i8]* @p_str33), !dbg !294 ; [debug line = 395:1]
  call void @llvm.dbg.value(metadata !{i16 %begin_index}, i64 0, metadata !295), !dbg !299 ; [debug line = 399:7] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %begin_index}, i64 0, metadata !295), !dbg !299 ; [debug line = 399:7] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %begin_index}, i64 0, metadata !295), !dbg !299 ; [debug line = 399:7] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %begin_sample}, i64 0, metadata !300), !dbg !299 ; [debug line = 399:7] [debug variable = i.sample]
  store i32 0, i32* %c, align 4
  br label %1, !dbg !299                          ; [debug line = 399:7]
...
; <label>:1                                       ; preds = %._crit_edge3, %0
  ...
  call void @llvm.dbg.value(metadata !{i32* %c}, i64 0, metadata !303), !dbg !304 ; [debug line = 407:4] [debug variable = c]
  %c_load = load i32* %c, align 4, !dbg !304      ; [#uses=2 type=i32] [debug line = 407:4]
  call void @llvm.dbg.value(metadata !{i16 %i_sample}, i64 0, metadata !300), !dbg !306 ; [debug line = 399:55] [debug variable = i.sample]
  call void @llvm.dbg.value(metadata !{i16 %i_sample}, i64 0, metadata !300), !dbg !306 ; [debug line = 399:55] [debug variable = i.sample]
  ...
  %tmp_i = icmp eq i16 %i_sample, %end_sample_read, !dbg !307 ; [#uses=1 type=i1] [debug line = 263:2@399:19]
  %tmp_i_12 = icmp eq i16 %i_index, %end_index_read, !dbg !307 ; [#uses=1 type=i1] [debug line = 263:2@399:19]
  %tmp_i_13 = and i1 %tmp_i, %tmp_i_12, !dbg !307 ; [#uses=1 type=i1] [debug line = 263:2@399:19]
  br i1 %tmp_i_13, label %._crit_edge, label %2, !dbg !312 ; [debug line = 399:19]

; <label>:2                                       ; preds = %1
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str34), !dbg !313 ; [#uses=1 type=i32] [debug line = 400:3]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 65535, i32 2000, [1 x i8]* @p_str212) nounwind, !dbg !314 ; [debug line = 401:1]
  ...
  %tmp_2 = zext i32 %offset to i64, !dbg !220     ; [#uses=1 type=i64] [debug line = 403:13]
  call void @llvm.dbg.value(metadata !{i32* %nfa_initials_buckets}, i64 0, metadata !317), !dbg !319 ; [debug line = 277:38@403:13] [debug variable = nfa.initials.buckets]
  call void @llvm.dbg.value(metadata !{i32* %nfa_finals_buckets}, i64 0, metadata !320), !dbg !319 ; [debug line = 277:38@403:13] [debug variable = nfa.finals.buckets]
  call void @llvm.dbg.value(metadata !{i32* %nfa_forward_buckets}, i64 0, metadata !321), !dbg !319 ; [debug line = 277:38@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{[32130 x i32]* %nfa_backward_buckets}, i64 0, metadata !322), !dbg !319 ; [debug line = 277:38@403:13] [debug variable = nfa.backward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa_symbols}, i64 0, metadata !323), !dbg !319 ; [debug line = 277:38@403:13] [debug variable = nfa.symbols]
  call void @llvm.dbg.value(metadata !{i16 %sample_length}, i64 0, metadata !216) nounwind, !dbg !224 ; [debug line = 279:11@403:13] [debug variable = length]
  %call_ret1 = call fastcc { i32, i32 } @nfa_get_initials(i32* %nfa_initials_buckets), !dbg !324 ; [#uses=2 type={ i32, i32 }] [debug line = 288:2@403:13]
  %current_buckets_0 = extractvalue { i32, i32 } %call_ret1, 0, !dbg !324 ; [#uses=1 type=i32] [debug line = 288:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %current_buckets_0}, i64 0, metadata !326), !dbg !324 ; [debug line = 288:2@403:13] [debug variable = current.buckets[0]]
  %current_buckets_1 = extractvalue { i32, i32 } %call_ret1, 1, !dbg !324 ; [#uses=1 type=i32] [debug line = 288:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %current_buckets_1}, i64 0, metadata !331), !dbg !324 ; [debug line = 288:2@403:13] [debug variable = current.buckets[1]]
  br label %3, !dbg !332                          ; [debug line = 291:7@403:13]
...
; <label>:3                                       ; preds = %8, %2
  ...
  %sum = add i64 %p_01_rec_i, %tmp_2              ; [#uses=1 type=i64]
  %sample_buffer_addr = getelementptr i8* %sample_buffer, i64 %sum ; [#uses=2 type=i8*]
  %tmp_3 = icmp ult i16 %i_0_i, %sample_length_read, !dbg !332 ; [#uses=1 type=i1] [debug line = 291:7@403:13]
  %i = add i16 %i_0_i, 1, !dbg !334               ; [#uses=1 type=i16] [debug line = 291:26@403:13]
  br i1 %tmp_3, label %4, label %bitset_any.exit, !dbg !332 ; [debug line = 291:7@403:13]

; <label>:4                                       ; preds = %3
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str12), !dbg !335 ; [#uses=1 type=i32] [debug line = 292:3@403:13]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1024, i32 512, [1 x i8]* @p_str212) nounwind, !dbg !337 ; [debug line = 294:1@403:13]
  %p_rec_i = add i64 %p_01_rec_i, 1, !dbg !338    ; [#uses=1 type=i64] [debug line = 295:26@403:13]
  %sym_req = call i1 @_ssdm_op_ReadReq.ap_bus.i8P(i8* %sample_buffer_addr, i32 1), !dbg !338 ; [#uses=0 type=i1] [debug line = 295:26@403:13]
  %sym = call i8 @_ssdm_op_Read.ap_bus.i8P(i8* %sample_buffer_addr), !dbg !338 ; [#uses=1 type=i8] [debug line = 295:26@403:13]
  call void @llvm.dbg.value(metadata !{i8 %sym}, i64 0, metadata !339) nounwind, !dbg !338 ; [debug line = 295:26@403:13] [debug variable = sym]
  %tmp_2_i = icmp eq i32 %next_buckets_0, 0, !dbg !340 ; [#uses=1 type=i1] [debug line = 199:3@303:12@403:13]
  br i1 %tmp_2_i, label %6, label %5, !dbg !340   ; [debug line = 199:3@303:12@403:13]
...
; <label>:5                                       ; preds = %6, %4
  ...
  %agg_result_bucket_index_0_lcssa4_i_cast_cast = zext i1 %agg_result_bucket_index_0_lcssa4_i to i2, !dbg !349 ; [#uses=1 type=i2] [debug line = 59:24@201:12@303:12@403:13]
  call void @llvm.dbg.value(metadata !{i32 %bus_assign}, i64 0, metadata !352) nounwind, !dbg !349 ; [debug line = 59:24@201:12@303:12@403:13] [debug variable = bus]
  %r_bit = call fastcc zeroext i5 @_bsf32_hw(i32 %bus_assign) nounwind, !dbg !353 ; [#uses=1 type=i5] [debug line = 61:9@201:12@303:12@403:13]
  br label %bitset_first.exit.preheader, !dbg !354 ; [debug line = 202:4@303:12@403:13]

; <label>:6                                       ; preds = %4
  %tmp_2_1_i = icmp eq i32 %next_buckets_1, 0, !dbg !340 ; [#uses=1 type=i1] [debug line = 199:3@303:12@403:13]
  br i1 %tmp_2_1_i, label %bitset_first.exit.preheader, label %5, !dbg !340 ; [debug line = 199:3@303:12@403:13]
...
bitset_first.exit.preheader:                      ; preds = %6, %5
  ...
  %j_bucket_index1_ph_cast = zext i2 %j_bucket_index1_ph to i8, !dbg !355 ; [#uses=1 type=i8] [debug line = 103:27@309:2@403:13]
  %j_bit1_ph_cast = zext i5 %j_bit1_ph to i8, !dbg !355 ; [#uses=1 type=i8] [debug line = 103:27@309:2@403:13]
  %tmp_10_i_cast = zext i8 %sym to i14, !dbg !355 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  br label %bitset_first.exit, !dbg !365          ; [debug line = 303:56@403:13]
...
bitset_first.exit:                                ; preds = %bitset_element.exit, %bitset_first.exit.preheader
  ...
  call void @llvm.dbg.value(metadata !{i1 %j_end}, i64 0, metadata !366), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.end]
  call void @llvm.dbg.value(metadata !{i1 %j_end}, i64 0, metadata !366), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.end]
  call void @llvm.dbg.value(metadata !{i1 %j_end}, i64 0, metadata !366), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.end]
  br i1 %j_end, label %7, label %bitset_element.exit, !dbg !379 ; [debug line = 303:37@403:13]

bitset_element.exit:                              ; preds = %bitset_first.exit
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str13), !dbg !380 ; [#uses=1 type=i32] [debug line = 304:4@403:13]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 64, i32 5, [1 x i8]* @p_str212) nounwind, !dbg !381 ; [debug line = 306:1@403:13]
  %tmp_6 = trunc i8 %j_bucket_index1 to i1        ; [#uses=1 type=i1]
  %tmp_i1 = call i6 @_ssdm_op_BitConcatenate.i6.i1.i5(i1 %tmp_6, i5 0), !dbg !382 ; [#uses=1 type=i6] [debug line = 187:2@307:18@403:13]
  %tmp_8 = trunc i8 %j_bit1 to i6, !dbg !365      ; [#uses=1 type=i6] [debug line = 303:56@403:13]
  %state = add i6 %tmp_i1, %tmp_8, !dbg !382      ; [#uses=1 type=i6] [debug line = 187:2@307:18@403:13]
  call void @llvm.dbg.value(metadata !{i6 %state}, i64 0, metadata !390) nounwind, !dbg !389 ; [debug line = 307:18@403:13] [debug variable = state]
  ...
  call void @llvm.dbg.value(metadata !{i32* %nfa_forward_buckets}, i64 0, metadata !391), !dbg !393 ; [debug line = 97:37@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa_symbols}, i64 0, metadata !394), !dbg !393 ; [debug line = 97:37@309:2@403:13] [debug variable = nfa.symbols]
  call void @llvm.dbg.value(metadata !{i6 %state}, i64 0, metadata !395), !dbg !396 ; [debug line = 97:50@309:2@403:13] [debug variable = state]
  call void @llvm.dbg.value(metadata !{i8 %sym}, i64 0, metadata !397), !dbg !398 ; [debug line = 97:66@309:2@403:13] [debug variable = sym]
  call void @llvm.dbg.value(metadata !{i32* %nfa_forward_buckets}, i64 0, metadata !399), !dbg !406 ; [debug line = 28:37@100:22@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa_symbols}, i64 0, metadata !407), !dbg !406 ; [debug line = 28:37@100:22@309:2@403:13] [debug variable = nfa.symbols]
  call void @llvm.dbg.value(metadata !{i32* %nfa_forward_buckets}, i64 0, metadata !408), !dbg !415 ; [debug line = 90:39@101:20@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa_symbols}, i64 0, metadata !416), !dbg !415 ; [debug line = 90:39@101:20@309:2@403:13] [debug variable = nfa.symbols]
  %nfa_symbols_read = call i8 @_ssdm_op_Read.ap_none.i8P(i8* %nfa_symbols), !dbg !417 ; [#uses=1 type=i8] [debug line = 93:2@101:20@309:2@403:13]
  %tmp_7_i_cast = zext i6 %state to i14, !dbg !355 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  call void @llvm.dbg.value(metadata !{i32* %nfa_forward_buckets}, i64 0, metadata !419), !dbg !422 ; [debug line = 90:39@103:27@309:2@403:13] [debug variable = nfa.forward.buckets]
  call void @llvm.dbg.value(metadata !{i8* %nfa_symbols}, i64 0, metadata !423), !dbg !422 ; [debug line = 90:39@103:27@309:2@403:13] [debug variable = nfa.symbols]
  %tmp_8_i_cast = zext i8 %nfa_symbols_read to i14, !dbg !355 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  %tmp_9_i = mul i14 %tmp_8_i_cast, %tmp_7_i_cast, !dbg !355 ; [#uses=1 type=i14] [debug line = 103:27@309:2@403:13]
  %tmp_11_i = add i14 %tmp_9_i, %tmp_10_i_cast, !dbg !355 ; [#uses=2 type=i14] [debug line = 103:27@309:2@403:13]
  %tmp_12_i = call i15 @_ssdm_op_BitConcatenate.i15.i14.i1(i14 %tmp_11_i, i1 false) ; [#uses=1 type=i15]
  %tmp_12_i_cast = zext i15 %tmp_12_i to i64      ; [#uses=1 type=i64]
  %nfa_forward_buckets_addr = getelementptr i32* %nfa_forward_buckets, i64 %tmp_12_i_cast ; [#uses=2 type=i32*]
  %tmp_buckets_0_2_req = call i1 @_ssdm_op_ReadReq.ap_bus.i32P(i32* %nfa_forward_buckets_addr, i32 1), !dbg !424 ; [#uses=0 type=i1] [debug line = 104:2@309:2@403:13]
  %tmp_buckets_0_1 = call i32 @_ssdm_op_Read.ap_bus.i32P(i32* %nfa_forward_buckets_addr), !dbg !424 ; [#uses=1 type=i32] [debug line = 104:2@309:2@403:13]
  %tmp_13_i = call i15 @_ssdm_op_BitConcatenate.i15.i14.i1(i14 %tmp_11_i, i1 true) ; [#uses=1 type=i15]
  %tmp_13_i_cast = zext i15 %tmp_13_i to i64      ; [#uses=1 type=i64]
  %nfa_forward_buckets_addr_1 = getelementptr i32* %nfa_forward_buckets, i64 %tmp_13_i_cast ; [#uses=2 type=i32*]
  %tmp_buckets_1_2_req = call i1 @_ssdm_op_ReadReq.ap_bus.i32P(i32* %nfa_forward_buckets_addr_1, i32 1), !dbg !424 ; [#uses=0 type=i1] [debug line = 104:2@309:2@403:13]
  %tmp_buckets_1_1 = call i32 @_ssdm_op_Read.ap_bus.i32P(i32* %nfa_forward_buckets_addr_1), !dbg !424 ; [#uses=1 type=i32] [debug line = 104:2@309:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_0_1}, i64 0, metadata !425), !dbg !363 ; [debug line = 309:2@403:13] [debug variable = tmp.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_1_1}, i64 0, metadata !427), !dbg !363 ; [debug line = 309:2@403:13] [debug variable = tmp.buckets[1]]
  %next_buckets_0_1 = or i32 %tmp_buckets_0_1, %tmp_buckets_0_3, !dbg !428 ; [#uses=1 type=i32] [debug line = 156:3@311:2@403:13]
  %next_buckets_1_1 = or i32 %tmp_buckets_1_1, %tmp_buckets_1_3, !dbg !428 ; [#uses=1 type=i32] [debug line = 156:3@311:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %next_buckets_0_1}, i64 0, metadata !437), !dbg !436 ; [debug line = 311:2@403:13] [debug variable = next.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %next_buckets_1_1}, i64 0, metadata !439), !dbg !436 ; [debug line = 311:2@403:13] [debug variable = next.buckets[1]]
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_7), !dbg !440 ; [#uses=0 type=i32] [debug line = 313:3@403:13]
  %call_ret6 = call fastcc { i8, i8, i32, i1 } @bitset_next(i32 %next_buckets_1, i8 %j_bit1, i8 %j_bucket_index1, i32 %j_bucket1), !dbg !365 ; [#uses=4 type={ i8, i8, i32, i1 }] [debug line = 303:56@403:13]
  %j_bit = extractvalue { i8, i8, i32, i1 } %call_ret6, 0, !dbg !365 ; [#uses=1 type=i8] [debug line = 303:56@403:13]
  %j_bucket_index = extractvalue { i8, i8, i32, i1 } %call_ret6, 1, !dbg !365 ; [#uses=1 type=i8] [debug line = 303:56@403:13]
  %j_bucket = extractvalue { i8, i8, i32, i1 } %call_ret6, 2, !dbg !365 ; [#uses=1 type=i32] [debug line = 303:56@403:13]
  %p_s = extractvalue { i8, i8, i32, i1 } %call_ret6, 3, !dbg !365 ; [#uses=1 type=i1] [debug line = 303:56@403:13]
  call void @llvm.dbg.value(metadata !{i8 %j_bit}, i64 0, metadata !441), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bit]
  call void @llvm.dbg.value(metadata !{i8 %j_bit}, i64 0, metadata !441), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bit]
  call void @llvm.dbg.value(metadata !{i8 %j_bit}, i64 0, metadata !441), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bit]
  call void @llvm.dbg.value(metadata !{i8 %j_bucket_index}, i64 0, metadata !444), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bucket_index]
  call void @llvm.dbg.value(metadata !{i8 %j_bucket_index}, i64 0, metadata !444), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bucket_index]
  call void @llvm.dbg.value(metadata !{i8 %j_bucket_index}, i64 0, metadata !444), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bucket_index]
  call void @llvm.dbg.value(metadata !{i32 %j_bucket}, i64 0, metadata !447), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bucket]
  call void @llvm.dbg.value(metadata !{i32 %j_bucket}, i64 0, metadata !447), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bucket]
  call void @llvm.dbg.value(metadata !{i32 %j_bucket}, i64 0, metadata !447), !dbg !365 ; [debug line = 303:56@403:13] [debug variable = j.bucket]
  br label %bitset_first.exit, !dbg !365          ; [debug line = 303:56@403:13]

; <label>:7                                       ; preds = %bitset_first.exit
  br i1 %any_0_i, label %8, label %nfa_accept_sample.exit, !dbg !450 ; [debug line = 315:3@403:13]

; <label>:8                                       ; preds = %7
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_0_3}, i64 0, metadata !425), !dbg !451 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_0_3}, i64 0, metadata !425), !dbg !451 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_1_3}, i64 0, metadata !427), !dbg !451 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_1_3}, i64 0, metadata !427), !dbg !451 ; [debug line = 317:3@403:13] [debug variable = tmp.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %next_buckets_0}, i64 0, metadata !437), !dbg !452 ; [debug line = 318:3@403:13] [debug variable = next.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %next_buckets_0}, i64 0, metadata !437), !dbg !452 ; [debug line = 318:3@403:13] [debug variable = next.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %next_buckets_1}, i64 0, metadata !439), !dbg !452 ; [debug line = 318:3@403:13] [debug variable = next.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %next_buckets_1}, i64 0, metadata !439), !dbg !452 ; [debug line = 318:3@403:13] [debug variable = next.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_0_3}, i64 0, metadata !326), !dbg !453 ; [debug line = 319:3@403:13] [debug variable = current.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_0_3}, i64 0, metadata !326), !dbg !453 ; [debug line = 319:3@403:13] [debug variable = current.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_1_3}, i64 0, metadata !331), !dbg !453 ; [debug line = 319:3@403:13] [debug variable = current.buckets[1]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_1_3}, i64 0, metadata !331), !dbg !453 ; [debug line = 319:3@403:13] [debug variable = current.buckets[1]]
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str12, i32 %tmp_4), !dbg !454 ; [#uses=0 type=i32] [debug line = 320:2@403:13]
  call void @llvm.dbg.value(metadata !{i16 %i}, i64 0, metadata !455) nounwind, !dbg !334 ; [debug line = 291:26@403:13] [debug variable = i]
  br label %3, !dbg !334                          ; [debug line = 291:26@403:13]

bitset_any.exit:                                  ; preds = %3
  %call_ret2 = call fastcc { i32, i32 } @nfa_get_finals(i32* %nfa_finals_buckets), !dbg !456 ; [#uses=2 type={ i32, i32 }] [debug line = 322:2@403:13]
  %tmp_buckets_0 = extractvalue { i32, i32 } %call_ret2, 0, !dbg !456 ; [#uses=1 type=i32] [debug line = 322:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_0}, i64 0, metadata !425), !dbg !456 ; [debug line = 322:2@403:13] [debug variable = tmp.buckets[0]]
  %tmp_buckets_1 = extractvalue { i32, i32 } %call_ret2, 1, !dbg !456 ; [#uses=1 type=i32] [debug line = 322:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %tmp_buckets_1}, i64 0, metadata !427), !dbg !456 ; [debug line = 322:2@403:13] [debug variable = tmp.buckets[1]]
  %current_buckets_0_1 = and i32 %next_buckets_0, %tmp_buckets_0, !dbg !457 ; [#uses=1 type=i32] [debug line = 166:3@324:2@403:13]
  %current_buckets_1_1 = and i32 %next_buckets_1, %tmp_buckets_1, !dbg !457 ; [#uses=1 type=i32] [debug line = 166:3@324:2@403:13]
  call void @llvm.dbg.value(metadata !{i32 %current_buckets_0_1}, i64 0, metadata !326), !dbg !462 ; [debug line = 324:2@403:13] [debug variable = current.buckets[0]]
  call void @llvm.dbg.value(metadata !{i32 %current_buckets_1_1}, i64 0, metadata !331), !dbg !462 ; [debug line = 324:2@403:13] [debug variable = current.buckets[1]]
  %tmp_1 = or i32 %current_buckets_1_1, %current_buckets_0_1, !dbg !463 ; [#uses=1 type=i32] [debug line = 176:3@327:9@403:13]
  %tmp_5 = icmp ne i32 %tmp_1, 0, !dbg !463       ; [#uses=1 type=i1] [debug line = 176:3@327:9@403:13]
  br label %nfa_accept_sample.exit, !dbg !470     ; [debug line = 327:9@403:13]

nfa_accept_sample.exit:                           ; preds = %bitset_any.exit, %7
  %r = phi i1 [ %tmp_5, %bitset_any.exit ], [ false, %7 ] ; [#uses=1 type=i1]
  call void @llvm.dbg.value(metadata !{i1 %r}, i64 0, metadata !471), !dbg !220 ; [debug line = 403:13] [debug variable = r]
  %or_cond = xor i1 %r, %accept_read, !dbg !472   ; [#uses=1 type=i1] [debug line = 404:3]
  br i1 %or_cond, label %._crit_edge3, label %9, !dbg !472 ; [debug line = 404:3]

; <label>:9                                       ; preds = %nfa_accept_sample.exit
  br i1 %stop_on_first_read, label %._crit_edge, label %10, !dbg !473 ; [debug line = 406:4]

; <label>:10                                      ; preds = %9
  %c_1 = add nsw i32 %c_load, 1, !dbg !304        ; [#uses=1 type=i32] [debug line = 407:4]
  call void @llvm.dbg.value(metadata !{i32 %c_1}, i64 0, metadata !303), !dbg !304 ; [debug line = 407:4] [debug variable = c]
  call void @llvm.dbg.value(metadata !{i32 %c_1}, i64 0, metadata !303), !dbg !304 ; [debug line = 407:4] [debug variable = c]
  store i32 %c_1, i32* %c, align 4, !dbg !304     ; [debug line = 407:4]
  br label %._crit_edge3, !dbg !474               ; [debug line = 408:3]

._crit_edge3:                                     ; preds = %10, %nfa_accept_sample.exit
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str34, i32 %tmp), !dbg !475 ; [#uses=0 type=i32] [debug line = 409:2]
  %call_ret7 = call fastcc { i16, i16 } @sample_iterator_next(i56* %indices, i16 %i_index, i16 %i_sample) ; [#uses=2 type={ i16, i16 }]
  %i_index_1 = extractvalue { i16, i16 } %call_ret7, 0, !dbg !306 ; [#uses=1 type=i16] [debug line = 399:55]
  %i_sample_1 = extractvalue { i16, i16 } %call_ret7, 1, !dbg !306 ; [#uses=1 type=i16] [debug line = 399:55]
  call void @llvm.dbg.value(metadata !{i16 %i_index_1}, i64 0, metadata !295), !dbg !306 ; [debug line = 399:55] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %i_index_1}, i64 0, metadata !295), !dbg !306 ; [debug line = 399:55] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %i_index_1}, i64 0, metadata !295), !dbg !306 ; [debug line = 399:55] [debug variable = i.index]
  call void @llvm.dbg.value(metadata !{i16 %i_sample_1}, i64 0, metadata !300), !dbg !306 ; [debug line = 399:55] [debug variable = i.sample]
  br label %1, !dbg !306                          ; [debug line = 399:55]

._crit_edge:                                      ; preds = %9, %1
  %p_0 = phi i32 [ %c_load, %1 ], [ 1, %9 ]       ; [#uses=1 type=i32]
  ret i32 %p_0, !dbg !476                         ; [debug line = 411:1]
}
...
._crit_edge:
  ...
  %tmp_1_cast = zext i16 %i_sample_read to i24, !dbg !506 ; [#uses=1 type=i24] [debug line = 271:79]
  %tmp_2 = mul i24 %tmp_1_cast, %tmp_cast, !dbg !506 ; [#uses=1 type=i24] [debug line = 271:79]
  %tmp_2_cast = zext i24 %tmp_2 to i32, !dbg !506 ; [#uses=1 type=i32] [debug line = 271:79]
  %offset = add i32 %tmp_2_cast, %tmp_9, !dbg !506 ; [#uses=1 type=i32] [debug line = 271:79]
...
define internal fastcc { i16, i16 } @sample_iterator_next(i56* %indices, i16 %i_index, i16 %i_sample) readonly {
  ...
  %tmp_s = zext i16 %i_index_read to i64, !dbg !519 ; [#uses=1 type=i64] [debug line = 250:2]
  ...
  %tmp_6_cast = zext i16 %indices_samples_load_new5 to i17, !dbg !519 ; [#uses=1 type=i17] [debug line = 250:2]
  %tmp_7 = add i17 %tmp_6_cast, -1, !dbg !519     ; [#uses=1 type=i17] [debug line = 250:2]
  %tmp_7_cast = sext i17 %tmp_7 to i18, !dbg !519 ; [#uses=1 type=i18] [debug line = 250:2]
  %tmp_8 = icmp slt i18 %tmp_cast, %tmp_7_cast, !dbg !519 ; [#uses=2 type=i1] [debug line = 250:2]
  %tmp_9 = add i16 %i_index_read, 1, !dbg !521    ; [#uses=1 type=i16] [debug line = 254:3]
  %tmp_1 = add i16 %i_sample_read, 1, !dbg !523   ; [#uses=1 type=i16] [debug line = 252:3]
  %agg_result_sample_write_assign = select i1 %tmp_8, i16 %tmp_1, i16 0, !dbg !519 ; [#uses=1 type=i16] [debug line = 250:2]
  %agg_result_index_write_assign = select i1 %tmp_8, i16 %i_index_read, i16 %tmp_9, !dbg !519 ; [#uses=1 type=i16] [debug line = 250:2]
...
!220 = metadata !{i32 403, i32 13, metadata !221, null}
!221 = metadata !{i32 786443, metadata !222, i32 400, i32 2, metadata !165, i32 46} ; [ DW_TAG_lexical_block ]
!222 = metadata !{i32 786443, metadata !223, i32 399, i32 2, metadata !165, i32 45} ; [ DW_TAG_lexical_block ]
...
!282 = metadata !{i32 381, i32 1, metadata !223, null}
!283 = metadata !{i32 382, i32 1, metadata !223, null}
!284 = metadata !{i32 383, i32 1, metadata !223, null}
!285 = metadata !{i32 385, i32 1, metadata !223, null}
!286 = metadata !{i32 386, i32 1, metadata !223, null}
!287 = metadata !{i32 387, i32 1, metadata !223, null}
!288 = metadata !{i32 388, i32 1, metadata !223, null}
!289 = metadata !{i32 390, i32 1, metadata !223, null}
!290 = metadata !{i32 391, i32 1, metadata !223, null}
!291 = metadata !{i32 392, i32 1, metadata !223, null}
!292 = metadata !{i32 393, i32 1, metadata !223, null}
!293 = metadata !{i32 394, i32 1, metadata !223, null}
!294 = metadata !{i32 395, i32 1, metadata !223, null}
!295 = metadata !{i32 790529, metadata !296, metadata !"i.index", null, i32 398, metadata !297, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!296 = metadata !{i32 786688, metadata !223, metadata !"i", metadata !165, i32 398, metadata !206, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!299 = metadata !{i32 399, i32 7, metadata !222, null}
!300 = metadata !{i32 790529, metadata !296, metadata !"i.sample", null, i32 398, metadata !301, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!303 = metadata !{i32 786688, metadata !223, metadata !"c", metadata !165, i32 397, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!304 = metadata !{i32 407, i32 4, metadata !305, null}
!305 = metadata !{i32 786443, metadata !221, i32 405, i32 3, metadata !165, i32 47} ; [ DW_TAG_lexical_block ]
!306 = metadata !{i32 399, i32 55, metadata !222, null}
...
!312 = metadata !{i32 399, i32 19, metadata !222, null}
!313 = metadata !{i32 400, i32 3, metadata !221, null}
!314 = metadata !{i32 401, i32 1, metadata !221, null}
!315 = metadata !{i32 786688, metadata !221, metadata !"offset", metadata !165, i32 402, metadata !182, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!316 = metadata !{i32 402, i32 20, metadata !221, null}
...
!471 = metadata !{i32 786688, metadata !221, metadata !"r", metadata !165, i32 403, metadata !31, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!472 = metadata !{i32 404, i32 3, metadata !221, null}
!473 = metadata !{i32 406, i32 4, metadata !305, null}
!474 = metadata !{i32 408, i32 3, metadata !305, null}
!475 = metadata !{i32 409, i32 2, metadata !221, null}
!476 = metadata !{i32 411, i32 1, metadata !223, null}
