...
#ifndef _nfa_accept_samples_generic_hw_start_indices_H_
#define _nfa_accept_samples_generic_hw_start_indices_H_
...
struct nfa_accept_samples_generic_hw_start_indices_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(nfa_accept_samples_generic_hw_start_indices_core);
    nfa_accept_samples_generic_hw_start_indices_core(sc_core::sc_module_name) {
    ...
    ~nfa_accept_samples_generic_hw_start_indices_core() {
        delete [] mem;
    }
...
SC_MODULE( nfa_accept_samples_generic_hw_start_indices )
{
    ...
    SC_CTOR( nfa_accept_samples_generic_hw_start_indices ) {
        meminst = new nfa_accept_samples_generic_hw_start_indices_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    nfa_accept_samples_generic_hw_start_indices_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_nfa_accept_samples_generic_hw_start_indices_H_
